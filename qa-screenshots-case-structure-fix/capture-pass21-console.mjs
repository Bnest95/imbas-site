...
const outDir = path.join(__dirname, '..', 'qa-screenshots-pass21-console');
...
await shot(375, 'workbench-console', null);
await shot(1440, 'workbench-console', null);
...
await browser.close();
console.log('saved to qa-screenshots-pass21-console/');
