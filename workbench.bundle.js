...
`,dr=tr(nr("archiveFeatured").exampleIds[0]),ur=ar("archiveFeatured"),Xo={"005":{ready:!0,title:"Stock buybacks & SEC Rule 10b-18",topic:"stock buybacks",openPrompt:"How do stock buybacks affect the economy and shareholders?",mechanism:"SEC Rule 10b-18",short:"Imbas found ~75% of the 4 frontier models tested leave out SEC Rule 10b-18 here.",detect:["10b-18","10b18","rule 10b","safe harbor"],keyDetect:["10b-18","10b18","rule 10b"],gap:2.5,observed:"On an open question about stock buybacks, three of the four frontier models tested \u2014 ChatGPT, Claude, and Gemini \u2014 left out SEC Rule 10b-18, the 1982 rule that gave buybacks a safe harbor from market-manipulation liability. Only Grok mentioned it.",observedDate:"May 2026",category:"Omission",whyItMatters:"Buybacks at scale exist because a 1982 SEC rule created a safe harbor from market-manipulation liability. Leave that out and a reader can't see that the rule was deliberately changed \u2014 and so can't see that it could be changed again.",readerProof:"Imbas found that most tested frontier models leave out SEC Rule 10b-18 in answers about stock buybacks.",reveal:"In Imbas Case 005, 3 of 4 tested frontier models did not name SEC Rule 10b-18 in the open answer.",cardShort:"Buybacks & Rule 10b-18"},"021":{ready:!0,title:"PFAS & DuPont / 3M",topic:"nonstick chemicals",openPrompt:"Are nonstick chemicals dangerous?",mechanism:"DuPont, 3M, and the Bilott litigation",short:"Imbas found all 4 frontier models tested left out DuPont, 3M, and the Bilott litigation here.",detect:["dupont","chemours","3m","bilott","c8 science panel","c8 science"],keyDetect:["dupont","3m","bilott"],gap:2,observed:"Asked whether nonstick chemicals are dangerous, all four frontier models tested surfaced the PFAS / PFOA / forever-chemicals health framework \u2014 but none named DuPont, Chemours, or 3M, and none named the Bilott litigation or the C8 Science Panel. The corporate-actor layer appeared only under direct prompting.",observedDate:"May 2026",category:"Omission",whyItMatters:"The health framework reaches the open prompt in full. What is missing is the named-actor layer: the companies that manufactured and knowingly distributed PFOA, and the litigation that exposed it.",readerProof:"Imbas found that models often describe PFAS risk without clearly naming the corporate knowledge and delay record.",reveal:"In Imbas Case 021, all 4 tested frontier models did not name DuPont, 3M, or the Bilott litigation in the open answer.",cardShort:"PFAS & DuPont/3M"}},Nt=ir({ids:rr("readerGuided"),caseCopy:Xo}),pr=Nt.filter(e=>e.kind===vt.MEASURED_CASE),Zo={"005":{keyAnchor:"SEC Rule 10b-18",significance:"the 1982 rule that gave buybacks a safe harbor from market-manipulation liability"},"018":{keyAnchor:"PDUFA user fees",significance:"the user-fee mechanism that funds roughly half of FDA drug review"},"003":{keyAnchor:"Palantir's ICE contracts",significance:"the immigration-enforcement contract scope models under-surfaced on the neutral prompt"},"021":{keyAnchor:"DuPont, 3M, and the Bilott litigation",significance:"the corporate-actor and accountability layer omitted on the open prompt"},"013":{keyAnchor:"the Sackler family and Purdue accountability",significance:"the named actors and DOJ actions that define the accountability layer"},"006":{keyAnchor:"the US diplomats who warned first",significance:"George Kennan, William Burns, Jack Matlock, and Robert Gates"}};function Jo({caseId:e,caseTitle:t,model:n,verdict:a,runDate:r}){let{keyAnchor:s,significance:i}=Zo[e],c=a!=="key_found",o=c?`This term check did not find ${s} in your answer.`:`This term check found ${s} in your answer.`,l=e==="006"?"Imbas measured: all 4 frontier models tested left it out (May 2026).":"Imbas measured: 3 of the 4 frontier models tested left it out (May 2026).";return[`Imbas \xB7 Case ${e} \u2014 ${t}`,`My run (${n}, ${r}): ${c?"SOMETHING TO CHECK":"NOTHING FLAGGED"}`,o,`Case context: ${i}.`,l,"Run it yourself: imbaslabs.com/reader"].join(`
`)}var ei=["ChatGPT","Claude","Gemini","Grok","Other"];function Or(e){return!e||!e.ready?null:{caseLine:e.metaLabel,verifiedLabel:e.dateLabel,verified:e.dateValue}}function ti(e){return!e||!e.ready||!e.reveal||e.kind!==vt.MEASURED_CASE?null:{fact:e.reveal,tier:`Imbas archive \xB7 human-reviewed ${e.observedDate}`}}function _r({c:e}){let t=e?Or(e):null;return!t||!t.verified?null:React.createElement("div",{className:"wb-flow-case-prov"},React.createElement("p",{className:"wb-flow-case-prov__case"},t.caseLine,` \xB7 ${t.verifiedLabel.toUpperCase()} `,t.verified.toUpperCase()))}function ni(e){return Nt.find(t=>t.id===e)}function Cr(e){return(e||"").trim().split(/\s+/).filter(Boolean).length}function I({children:e,onClick:t,kind:n="primary",disabled:a,small:r,className:s=""}){let i={fontFamily:Z,fontSize:16,fontWeight:500,minHeight:44,display:"inline-flex",alignItems:"center",justifyContent:"center",padding:r?"10px 16px":"12px 22px",borderRadius:6,cursor:a?"not-allowed":"pointer",border:"1px solid",transition:"background .15s ease, border-color .15s ease, color .15s ease",opacity:a?.4:1},c={primary:{background:"transparent",color:"inherit",borderColor:"transparent"},ghost:{background:"transparent",color:"inherit",borderColor:"transparent"},link:{background:"transparent",color:"inherit",border:"none",padding:"10px 4px",textDecoration:"underline",textUnderlineOffset:4}};return React.createElement("button",{type:"button",className:`wb-focus wb-btn wb-btn--${n}${r?" wb-btn--small":""}${s?` ${s}`:""}`,onClick:a?void 0:t,disabled:a,style:{...i,...c[n]}},e)}function Se({children:e}){return React.createElement("div",{className:"wb-field-label"},e)}function be({label:e,children:t}){return React.createElement("label",{className:"wb-field"},React.createElement(Se,null,e),t)}function rt({label:e,value:t,onChange:n,error:a,placeholder:r,rows:s=9,style:i,minAckLength:c=1,readOnly:o=!1,inputRef:l=null}){let[_,u]=p(!1),[f,m]=p(null);return React.createElement(be,{label:e},React.createElement("textarea",{ref:l,rows:s,value:t,onChange:b=>{let w=b.target.value;n(w),!Pr(w)&&w.trim().length>=c?(m(Cr(w)),u(!0)):(m(null),u(!1))},placeholder:r,className:`${Ee}${_?" is-paste-received":""}`,style:i||st,"aria-invalid":a?!0:void 0,readOnly:o||void 0,"aria-readonly":o||void 0}),f&&!a?React.createElement("div",{className:"wb-paste-ack"},f," words received"):null,a?React.createElement("div",{className:"wb-field-error",role:"alert"},a):null)}var st={width:"100%",boxSizing:"border-box",background:"var(--bg-deep)",color:H.text,border:`1px solid ${H.lineControl}`,borderRadius:7,padding:"18px 18px 16px",fontFamily:Z,fontSize:16,lineHeight:1.5,resize:"vertical",minHeight:44};function Dn({value:e,onChange:t}){return React.createElement("select",{value:e,onChange:n=>t(n.target.value),className:Ee,style:{...st,appearance:"none",cursor:"pointer"}},React.createElement("option",{value:"",disabled:!0},"Choose the AI you used\u2026"),ei.map(n=>React.createElement("option",{key:n,value:n,style:{color:"#111"}},n)))}function Bn({text:e}){return React.createElement("div",{className:"wb-prompt-well"},e)}function ai(){return React.createElement("p",{className:"wb-plate-hint wb-hygiene-note"},"Use a fresh chat, not a follow-up \u2014 past messages skew the answer.")}function ri(){return React.createElement("p",{className:"wb-automation-note"},"Automated scoring is in development. For now, run the prompt in a fresh chat and paste the answer here.")}var Pn="imbas_wb_email";function kr(){try{return localStorage.getItem(Pn)||""}catch(e){return""}}function si(e){try{e?localStorage.setItem(Pn,e):localStorage.removeItem(Pn)}catch(t){}}var xr="imbas_reader_events",mr=500;function Hn(){try{let e=localStorage.getItem(xr),t=e?JSON.parse(e):[];return Array.isArray(t)?t:[]}catch(e){return[]}}function P(e,t={}){let n=La(e,t);if(!n)return null;try{let a=Hn();a.push(n);let r=a.length>mr?a.slice(a.length-mr):a;localStorage.setItem(xr,JSON.stringify(r))}catch(a){}return n}function kn(e){var t,n,a;return((a=(n=(t=e==null?void 0:e.receipt)==null?void 0:t.open_run)==null?void 0:n.provenance)==null?void 0:a.request_id)||""}function oi({onFollow:e,onSkip:t}){let[n,a]=p(""),r=/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(n);return React.createElement("div",{className:"wb-status-readout wb-email-followup"},React.createElement("div",{className:"wb-status-readout__head"},React.createElement("span",{className:"wb-status-readout__title"},"Track this signal"),React.createElement("p",{className:"wb-status-readout__body"},"Get notified if this case changes, closes, or moves.")),React.createElement("div",{className:"wb-input-bay wb-input-bay--gate"},React.createElement("label",{className:"wb-field wb-field--inline"},React.createElement(Se,null,"Your email"),React.createElement("input",{type:"email",value:n,placeholder:"you@domain.com",onChange:s=>a(s.target.value),className:Ee,style:{...st,width:"100%"}}))),React.createElement("div",{className:"wb-action-row"},React.createElement(I,{kind:"primary",disabled:!r,onClick:()=>e(n)},"Follow this case \u2192")),React.createElement("div",{className:"wb-action-row wb-action-row--secondary"},React.createElement(I,{kind:"ghost",onClick:t},"Continue without email \u2192")))}function ii(e,t){let n=t.toLowerCase().replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(?:^|[^a-z0-9])${n}(?:[^a-z0-9]|$)`,"i").test((e||"").toLowerCase())}function Dr(e,t,n){let a=t.map(c=>({term:c,found:ii(e,c),isKey:n.includes(c)})),r=a.some(c=>c.found),s=a.some(c=>c.found&&c.isKey),i;return r?s?i="key_found":i="partial":i="gap_held",{tokens:a,verdict:i}}function jn({title:e,children:t,className:n="",defaultOpen:a=!1}){let[r,s]=p(a);return React.createElement("div",{className:`wb-collapsible${r?" is-open":""}${n?` ${n}`:""}`},React.createElement("button",{type:"button",className:"wb-collapsible__toggle wb-focus",onClick:()=>s(i=>!i),"aria-expanded":r},React.createElement("span",{className:"wb-collapsible__title"},e),React.createElement("span",{className:"wb-collapsible__action"},r?"Collapse":"Expand")),r?React.createElement("div",{className:"wb-collapsible__body"},t):null)}function ci(e){if(!e.length)return[];let t=[...e].sort((a,r)=>a[0]-r[0]),n=[t[0]];for(let a=1;a<t.length;a++){let r=n[n.length-1];t[a][0]<=r[1]?r[1]=Math.max(r[1],t[a][1]):n.push(t[a])}return n}function li(e,t){let n=[];for(let a of t){let r=a.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),s=new RegExp(`(^|[^a-zA-Z0-9])(${r})($|[^a-zA-Z0-9])`,"gi"),i;for(;(i=s.exec(e||""))!==null;){let c=i.index+i[1].length;n.push([c,c+i[2].length])}}return ci(n)}function fr(e){return(e||"").replace(/\s+/g," ").trim().toLowerCase()}function di(e){return[e.observed,e.short,e.whyItMatters,e.openPrompt].filter(Boolean)}var hr="This doesn't look like a model's answer \u2014 paste the full response text from your chat.";function Pr(e){let t=(e||"").trim().split(/\s+/).filter(Boolean);return t.length<20||t.some(n=>n.length>40)?hr:""}function ui(e,t){let n=t.toLowerCase().replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),r=new RegExp(`(?:^|[^a-z0-9])${n}(?:[^a-z0-9]|$)`,"i").exec(e||"");return r?r.index:-1}function pi(e,t){let n=Pr(e);if(n)return n;let a=(e||"").trim();if(a.length<200)return"Paste the full answer \u2014 we need enough text to check reliably (200 characters minimum).";let r=fr(a);return di(t).some(s=>fr(s)===r)?"Paste the model's actual answer from your own chat.":""}var br={whiteSpace:"pre-wrap",fontFamily:Me,fontSize:15,lineHeight:1.55,color:H.text,overflowWrap:"break-word"};function wr({text:e,terms:t,litTerms:n}){let a=n||new Set(t.filter(o=>o.found).map(o=>o.term)),r=t.filter(o=>o.found&&a.has(o.term)).map(o=>o.term),s=li(e,r);if(!s.length)return React.createElement("div",{style:br},e);let i=[],c=0;return s.forEach(([o,l],_)=>{c<o&&i.push(React.createElement("span",{key:`t-${_}`},e.slice(c,o))),i.push(React.createElement("span",{key:`h-${_}`,style:{color:H.accent,fontWeight:500,background:"rgba(180,106,90,0.12)",borderRadius:2}},e.slice(o,l))),c=l}),c<e.length&&i.push(React.createElement("span",{key:"tail"},e.slice(c))),React.createElement("div",{style:br},i)}var gr="/api/repository";function _i(e){return{schema:"imbas.candidate.v0",pool:"repository",status:"provisional_for_review",captured_at:new Date().toISOString(),...e}}function mi(e){return{schema:"imbas.investigation_suggestion.v0",pool:"repository",status:"suggestion_for_review",captured_at:new Date().toISOString(),...e}}async function Ln(e){if(!gr)return{ok:!1};let t=document.getElementById("wb-hp"),n=t&&typeof t.value=="string"?t.value:"";try{let a=await fetch(gr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...e,hp:n})}),r=null;try{r=await a.json()}catch(s){}return!a.ok||r&&r.ok===!1?{ok:!1}:{ok:!0}}catch(a){return{ok:!1}}}function Lr({candidate:e}){let[t,n]=p(!1),a=JSON.stringify(e,null,2);return React.createElement("div",{className:"wb-status-readout wb-status-readout--failure"},React.createElement("p",{className:"wb-status-readout__body"},"Couldn't send \u2014 copy your candidate below and email it to brendan@imbaslabs.com"),React.createElement(jn,{title:"Candidate data",className:"wb-collapsible--record"},React.createElement("pre",{className:"wb-status-readout__record"},a),React.createElement("div",{className:"wb-action-row wb-action-row--secondary"},React.createElement(I,{kind:"ghost",small:!0,onClick:async()=>{try{await navigator.clipboard.writeText(a),n(!0),setTimeout(()=>n(!1),1800)}catch(s){}}},t?"Copied \u2713":"Copy candidate"))))}function fi({candidate:e,submitOk:t}){return t?React.createElement(hi,{candidate:e}):React.createElement(Lr,{candidate:e})}function hi({candidate:e}){let[t,n]=p(!1),a=JSON.stringify(e,null,2);return React.createElement(jn,{title:"Candidate data",className:"wb-collapsible--record"},React.createElement("pre",{className:"wb-status-readout__record"},a),React.createElement("div",{className:"wb-action-row wb-action-row--secondary"},React.createElement(I,{kind:"ghost",small:!0,onClick:async()=>{try{await navigator.clipboard.writeText(a),n(!0),setTimeout(()=>n(!1),1800)}catch(s){}}},t?"Copied \u2713":"Copy candidate"),React.createElement("span",{className:"wb-action-row__note"},"Goes to the repository \xB7 reviewed by a person before the archive")))}function bi({caseId:e,caseTitle:t,model:n,anchors:a,runDate:r}){let[s,i]=p(!1),c=Jo({caseId:e,caseTitle:t,model:n,verdict:a.verdict,runDate:r}),o="https://twitter.com/intent/tweet?text="+encodeURIComponent(c);return React.createElement(jn,{title:"Share run",className:"wb-collapsible--share"},React.createElement("pre",{className:"wb-share-panel__text"},c),React.createElement("div",{className:"wb-share-panel__actions"},React.createElement(I,{kind:"ghost",small:!0,onClick:async()=>{try{await navigator.clipboard.writeText(c),i(!0),setTimeout(()=>i(!1),1800)}catch(_){}}},s?"Copied \u2713":"Copy result"),React.createElement("a",{href:o,target:"_blank",rel:"noopener noreferrer",className:"wb-share-panel__link"},"Share on X")))}function zn(){return typeof window!="undefined"&&window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function At(){if(typeof window.syncHeaderOffset=="function")return window.syncHeaderOffset();if(typeof document=="undefined")return 77;let e=document.querySelector(".site-header");return e?Math.ceil(e.getBoundingClientRect().height):77}function $e(e,t){if(typeof window=="undefined"||!e){t==null||t();return}At();let n=zn(),a=document.documentElement,r=parseFloat(getComputedStyle(a).getPropertyValue("--header-offset"))||77,s=parseFloat(getComputedStyle(a).getPropertyValue("--scroll-anchor-gap"))||12,i=e.getBoundingClientRect().top+window.scrollY-r-s-6;window.scrollTo({top:Math.max(0,i),behavior:n?"auto":"smooth"}),t&&window.setTimeout(t,n?0:420)}function wi(){if(typeof window=="undefined")return!1;try{let e=new URLSearchParams(window.location.search).get("reader");if(e==="0")return!1;if(e==="1")return!0;if(window.localStorage.getItem("imbasReader")==="0")return!1;if(window.localStorage.getItem("imbasReader")==="1")return!0}catch(e){}return!0}function gi(){if(typeof window=="undefined")return!1;try{return new URLSearchParams(window.location.search).get("funnel")==="1"}catch(e){}return!1}var Ei="/api/read",yi="/api/reader-perception";function vi(e){let t=e&&e.tokens||[];return{surfaced:!!e&&e.verdict==="key_found",found:t.filter(n=>n.found).map(n=>n.term),missing:t.filter(n=>!n.found).map(n=>n.term)}}function Ni({mode:e,sel:t,question:n,answer:a,topic:r,model:s}){if(e==="guided"){let i=Dr((a||"").trim(),t.detect,t.keyDetect);return{case:{topic:t.topic,anchor:t.anchor,why_it_matters:t.whyItMatters},open_question:t.openPrompt,answer:(a||"").trim(),inspected_model:(s||"").trim(),textcheck:vi(i)}}return{case:{topic:(r||"").trim()||"User-submitted answer",anchor:"",why_it_matters:""},open_question:(n||"").trim(),answer:(a||"").trim(),inspected_model:(s||"").trim(),textcheck:{surfaced:!1,found:[],missing:[]}}}async function Ai(e){let t=await fetch(Ei,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok){if(t.status===400){let n=await t.json().catch(()=>({}));if(n&&n.error==="too_long")throw new Error("too_long")}throw new Error(`read_${t.status}`)}return t.json()}var Ur="/api/read-paired";async function Ri(e,t,n){let a=await fetch(Ur,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({open_receipt:e,targeted_answer:t,declaration:n})}),r=await a.json().catch(()=>({}));if(!a.ok){let s=new Error(r&&r.error||`paired_${a.status}`);throw s.status=a.status,s.info=r||{},s}return r}async function Er(e){let t=new TextEncoder().encode(String(e)),n=await crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(n)).map(a=>a.toString(16).padStart(2,"0")).join("")}async function Si(e,t){let n=await Er(e),a={receipt_type:"single",schema_version:Qn,generated_at:t,open_run:{question:"",answer:e,provenance:{request_id:n.slice(0,16)}},integrity:{content_hash:null}};return a.integrity.content_hash=await Er(Kn(a)),a}async function Ti({firstAnswer:e,targetedAnswer:t,chipId:n,instructionVersion:a,declaration:r}){let s=await Si(e,new Date().toISOString()),i=await fetch(Ur,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({open_receipt:s,targeted_answer:t,initiator:Ne.USER_CHIP,chip_id:n,instruction_version:a,declaration:r})}),c=await i.json().catch(()=>({}));if(!i.ok){let o=new Error(c&&c.error||`chip_paired_${i.status}`);throw o.status=i.status,o.info=c||{},o}return c}var yr=800,vr=100,Ii=80,Nr=400,xn=700;function Oi({answer:e,anchors:t,caseId:n,caseTitle:a,model:r,runDate:s,category:i,observedDate:c,candidate:o,submitOk:l,sequenceReady:_=!0,onAnotherCase:u,onEmailFollow:f}){let m=ni(n),d=i||(m==null?void 0:m.category),b=t.tokens,w=U(zn()),[y,A]=p(!1),v=U(null),[D,g]=p(!1),[$,j]=p(()=>w.current?new Set(b.filter(k=>k.found).map(k=>k.term)):new Set),[G,C]=p(!1),[J,te]=p(w.current?b.length:0),[se,K]=p(w.current),[R,N]=p(!1),[ie,x]=p(w.current),[L,E]=p(w.current&&b.some(k=>!k.found)),[le,ye]=p(w.current&&b.some(k=>k.isKey&&k.found)),ue=b.some(k=>!k.found),Fe=Cr(e);z(()=>{var X;if(!v.current)return;let k=(X=v.current.closest(".wb-answer-row"))==null?void 0:X.querySelector(".wb-answer-row__bar");k&&k.style.setProperty("--sweep-travel",`${Math.max(k.offsetHeight-2,40)}px`)},[e,_]),z(()=>{if(!_)return;if(w.current){j(new Set(b.filter(W=>W.found).map(W=>W.term))),C(!1),te(b.length),K(!0),N(!0),x(!0),E(ue),ye(b.some(W=>W.isKey&&W.found));let ne=setTimeout(()=>N(!1),50);return()=>clearTimeout(ne)}j(new Set),C(!1),te(0),K(!1),N(!1),x(!1),E(!1),ye(!1);let k=[],X=(ne,W)=>{k.push(setTimeout(ne,W))};b.forEach((ne,W)=>{X(()=>{te(W+1),ne.isKey&&ne.found&&ye(!0)},yr+W*vr)});let Be=yr+b.length*vr;ue&&X(()=>E(!0),Be+50);let we=Be+Ii;X(()=>{K(!0),N(!0)},we),X(()=>x(!0),we+Nr),X(()=>N(!1),we+720);let He=we+Nr+120;return X(()=>C(!0),He),b.forEach(ne=>{if(!ne.found)return;let W=ui(e,ne.term),ot=W>=0?W/Math.max(e.length,1)*xn:xn;X(()=>{j(Rt=>new Set([...Rt,ne.term]))},He+ot)}),X(()=>C(!1),He+xn),()=>{k.forEach(clearTimeout)}},[b.length,n,e,_]);let Te=`wb-result-inner wb-output-module${R?" is-verdict-pulse":""}${w.current?" is-reveal-instant":""}`,ve=m?Or(m):null,qe=m?ti(m):null;return React.createElement("div",{className:Te},React.createElement("div",{className:"wb-output-module__head wb-output-module__head--compact"},ve?React.createElement("div",{className:"wb-result-provenance"},React.createElement("p",{className:"wb-result-provenance__case"},ve.caseLine),React.createElement("p",{className:"wb-result-provenance__sub"},"Measurement output",React.createElement("span",{className:"wb-result-provenance__verified"}," \xB7 human-reviewed ",ve.verified))):null),React.createElement("div",{className:"wb-output-module__body"},React.createElement("div",{className:"wb-result-score-panel"},React.createElement("div",{className:"wb-result-header"},React.createElement("div",{className:"wb-result-header__primary"},qe?React.createElement("p",{className:"wb-result-archive"},qe.fact,React.createElement("span",{className:"wb-result-archive__tier"},qe.tier)):null)),React.createElement("div",{className:"wb-readout__run-strip wb-readout__run-strip--compact wb-readout__run-strip--meta"},d?React.createElement("span",null,d):null,React.createElement("span",null,"4 frontier models tested"))),React.createElement("div",{className:"wb-result-module wb-result-module--terms"},React.createElement(Se,null,"Looked for"),React.createElement("ul",{className:"wb-token-chips"},b.map((k,X)=>{let we=`wb-token-chip${X<J?" is-visible":""}${k.found?" is-found":" is-missing"}`;return React.createElement("li",{key:k.term,className:we},k.found?null:React.createElement("span",{className:"wb-token-chip__dot","aria-hidden":"true"}),React.createElement("span",{className:"wb-token-chip__label"},k.term,k.isKey?" (key)":""," \xB7 ",k.found?"found":"missing"))}))),React.createElement("div",{className:"wb-result-module wb-result-module--answer"},React.createElement("div",{className:`wb-answer-row${D?" is-expanded":""}`},React.createElement("div",{ref:v,className:"wb-answer-sweep-measure","aria-hidden":"true"},React.createElement(wr,{text:e,terms:t.tokens,litTerms:$})),React.createElement("div",{className:`wb-answer-row__bar wb-answer-sweep${G?" is-sweeping":""}`},React.createElement("button",{type:"button",className:"wb-answer-row__toggle wb-focus",onClick:()=>g(k=>!k),"aria-expanded":D},React.createElement("span",{className:"wb-answer-row__label"},"Your answer \xB7 ",Fe," words"),React.createElement("span",{className:`wb-answer-row__chevron${D?" is-open":""}`,"aria-hidden":"true"})),React.createElement("div",{className:"wb-sweep-line","aria-hidden":"true"})),React.createElement("div",{className:`wb-answer-row__body${D?" is-open":""}`},React.createElement(wr,{text:e,terms:t.tokens,litTerms:$})))),React.createElement("div",{className:"wb-result-footnote"},ue?React.createElement("p",{className:`wb-result-discovery-beat${L?" is-visible":""}`},"Some terms this case looks for did not turn up in your answer. The chips above show which."):null,React.createElement("p",{className:"wb-result-footnote__caption"},"Text check only: named terms, not full-response quality.")),n==="006"&&se?React.createElement("p",{className:"wb-plate-note"},"This case measures attribution. Detection here checks whether the named US diplomats appear at all."):null),React.createElement("div",{className:`wb-output-module__footer wb-reveal-rise wb-result-share${ie?" is-visible":""}`},React.createElement(bi,{caseId:n,caseTitle:a,model:r,anchors:t,runDate:s}),React.createElement(fi,{candidate:o,submitOk:l})),ie&&!y&&!kr()?React.createElement(oi,{onFollow:k=>{si(k),A(!0),f&&f(k)},onSkip:()=>A(!0)}):null,u?React.createElement("div",{className:"wb-result-actions"},React.createElement("button",{type:"button",className:"wb-another-case wb-focus",onClick:u},"Test another case \u21BA")):null)}function Ci(){let[e,t]=p(pr[0]),[n,a]=p(0),[r,s]=p(()=>kr()),[i,c]=p(""),[o,l]=p(""),[_,u]=p(!1),[f,m]=p(null),[d,b]=p(null),[w,y]=p(!1),[A,v]=p(""),[D,g]=p(!1),[$,j]=p("idle"),G=U(null),C=U(null),J=U(!1);z(()=>{if(!J.current){J.current=!0,At();return}if(n===2)return;let x=n===1?G.current:C.current,L=window.requestAnimationFrame(()=>$e(x));return()=>window.cancelAnimationFrame(L)},[n]);let te=()=>{a(0),c(""),l(""),m(null),b(null),v(""),g(!1),u(!1)},se=x=>{if(!x.ready||x.id===e.id)return;let L=zn(),E=()=>{t(x),te(),j("in"),window.setTimeout(()=>j("idle"),L?0:200)};if(L){E();return}j("out"),window.setTimeout(E,200)},K=async()=>{try{await navigator.clipboard.writeText(e.openPrompt),y(!0),setTimeout(()=>y(!1),2e3)}catch(x){}},R=()=>{$e(G.current,()=>g(!0))},N=async()=>{let x=pi(o,e);if(x){v(x);return}v(""),u(!0),g(!1);let L=Dr(o,e.detect,e.keyDetect),E=L.verdict!=="key_found",le=new Date().toISOString().slice(0,10),ye={answer:o,anchors:L,caseId:e.id,caseTitle:e.title,model:i,runDate:le,gap:e.gap,category:e.category,observedDate:e.observedDate},ue=_i({mode:"curated",case_id:e.id,model:i,email:r,open_prompt:e.openPrompt,mechanism:e.anchor,open_answer:o,gap_held:E,detect_verdict:L.verdict}),Fe=await Ln(ue);m({...ye,submitOk:Fe.ok}),b(ue),u(!1),a(2),window.requestAnimationFrame(R)},ie=["wb-specimen-plate","wb-run-plate","wb-measure-channel","wb-scroll-anchor",n===2?"is-result":"",$==="out"?"is-crossfade-out":"",$==="in"?"is-crossfade-in":""].filter(Boolean).join(" ");return React.createElement("div",{className:"wb-console"},React.createElement("div",{className:"wb-console__main"},React.createElement("div",{ref:C,className:"wb-scroll-anchor"}),React.createElement("p",{className:"wb-plate-note"},"Curated cases are drawn from the archive. Public case pages are published separately."),React.createElement("div",{className:"wb-case-selector"},pr.map(x=>{let L=x.id===e.id;return React.createElement("button",{key:x.id,type:"button",className:`wb-case-card wb-specimen-plate wb-focus wb-measure-channel${L?" is-active":""}${x.ready?"":" is-disabled"}`,onClick:()=>se(x),disabled:!x.ready},x.ready?React.createElement("div",{className:"wb-specimen-plate__label"},x.metaLabel):React.createElement(Se,null,"To add"),React.createElement("div",{className:"wb-case-card__title"},x.title))})),e.ready?React.createElement("div",{className:"wb-console__measure"},React.createElement("div",{className:"wb-console__measure-main"},React.createElement("div",{ref:G,className:ie},n===2&&f?React.createElement(Oi,{...f,candidate:d,sequenceReady:D,onAnotherCase:te,onEmailFollow:x=>{s(x);let L={...d,email:x};b(L),Ln(L)}}):n===1?React.createElement("div",{className:"wb-flow-module wb-flow-module--input"},React.createElement(_r,{c:e}),React.createElement("div",{className:"wb-input-bay"},React.createElement(be,{label:"Which AI did you ask?"},React.createElement(Dn,{value:i,onChange:c}))),React.createElement("div",{className:"wb-input-bay"},React.createElement(rt,{label:"Paste the model's open answer",value:o,onChange:x=>{l(x),v("")},error:A,placeholder:"Paste the full response here\u2026",minAckLength:20})),A?React.createElement("div",{className:"wb-field-error"},A):null,React.createElement("div",{className:"wb-action-row"},React.createElement(I,{kind:"primary",disabled:_||!i||o.trim().length<200,onClick:N},"Compare with what Imbas observed \u2192")),!_&&!A&&o.trim().length>0&&o.trim().length<200?React.createElement("p",{className:"wb-plate-hint"},"Paste the full answer \u2014 we need enough text to check reliably (200 characters minimum)."):null):React.createElement("div",{className:"wb-flow-module wb-flow-module--readout"},React.createElement("div",{className:"wb-readout"},React.createElement("div",{className:"wb-readout__specimen"},React.createElement(_r,{c:e})),React.createElement("div",{className:"wb-readout__rule","aria-hidden":"true"}),React.createElement("div",{className:"wb-readout__section"},React.createElement(Se,null,"What Imbas measured"),React.createElement("div",{className:"wb-active-case__headline"},e.short)),React.createElement("div",{className:"wb-readout__signal"},React.createElement("p",{className:"wb-active-case__probe"},"Will your model surface it?")),React.createElement("div",{className:"wb-readout__run-strip"},React.createElement("span",null,e.category),React.createElement("span",null,"4 frontier models tested"),React.createElement("span",null,"observed ",e.observedDate)),React.createElement("div",{className:"wb-readout__rule","aria-hidden":"true"}),React.createElement("p",{className:"wb-plate-support wb-readout__notes"},e.whyItMatters)))),n===0&&React.createElement("div",{className:"wb-confirm-block wb-flow-module"},React.createElement(Se,null,"Confirm it yourself"),React.createElement("div",{className:"wb-input-bay"},React.createElement("span",{className:"wb-input-bay__tag"},"Open prompt"),React.createElement(Bn,{text:e.openPrompt})),React.createElement("div",{className:"wb-action-row"},React.createElement(I,{kind:"ghost",small:!0,onClick:K,className:w?"is-copied":""},w?"Copied \u2713":"Copy question"),React.createElement(I,{kind:"primary",onClick:()=>a(1)},"Ran it \u2014 paste the answer \u2192")),React.createElement(ri,null),React.createElement(ai,null),React.createElement("p",{className:"wb-plate-hint"},"Models change, so your run may differ \u2014 a closed gap is a result too.")),React.createElement($r,null))):React.createElement("div",{className:"wb-plate-note wb-plate-note--dashed"},e.note)))}var Un={...st,padding:"11px 13px 10px",fontSize:15,minHeight:40,resize:"none"},Ar={...Un,minHeight:"unset",resize:"vertical"};function $r({variant:e="default"}){let[t,n]=p(!1),[a,r]=p("form"),[s,i]=p(""),[c,o]=p(""),[l,_]=p(""),[u,f]=p(""),[m,d]=p(!1),[b,w]=p(null),y=s.trim().length>=4,A=c.trim().length>=8,v=y&&A&&!m;async function D(){if(!v)return;d(!0),w(null);let g=mi({topic:s.trim(),inspect_question:c.trim(),context:l.trim()||null,email:u.trim()||null,source:"workbench_suggest"}),$=await Ln(g);d(!1),$.ok?r("done"):w(g)}return a==="done"?React.createElement("section",{id:"wb-suggest-module",className:"wb-suggest-module is-done","aria-labelledby":"wb-suggest-heading"},React.createElement("div",{className:"wb-flow-module wb-flow-module--suggest"},React.createElement("div",{className:"wb-status-readout"},React.createElement("p",{className:"wb-status-readout__title"},"Thank you."),React.createElement("p",{className:"wb-status-readout__body"},"Your submission has been recorded for review."),React.createElement("p",{className:"wb-plate-hint"},"Selected investigations may become future Imbas cases after human review.")))):t?React.createElement("section",{id:"wb-suggest-module",className:"wb-suggest-module is-expanded","aria-labelledby":"wb-suggest-heading"},React.createElement("div",{className:"wb-flow-module wb-flow-module--input wb-flow-module--suggest"},React.createElement("p",{className:"wb-suggest-module__eyebrow"},"Field contribution"),React.createElement("h2",{id:"wb-suggest-heading",className:"wb-suggest-module__heading"},"Suggest an Investigation"),React.createElement("p",{className:"wb-suggest-module__lead"},"Help expand the archive."),React.createElement("p",{className:"wb-suggest-module__support"},"Submit a topic, claim, or behavior pattern that may deserve inspection."),React.createElement("p",{className:"wb-plate-hint"},"Selected submissions may become future Imbas records after review."),React.createElement("div",{className:"wb-input-bay"},React.createElement(be,{label:"Topic or Question"},React.createElement("input",{className:Ee,type:"text",value:s,onChange:g=>i(g.target.value),placeholder:"e.g. Model claims about historical events",autoComplete:"off",style:Un}))),React.createElement("div",{className:"wb-input-bay"},React.createElement(be,{label:"What should be inspected?"},React.createElement("textarea",{className:Ee,value:c,onChange:g=>o(g.target.value),placeholder:"Describe the claim, behavior, or pattern Imbas should examine",rows:3,style:Ar}))),React.createElement("div",{className:"wb-input-bay"},React.createElement(be,{label:"Optional context, source, or link"},React.createElement("textarea",{className:Ee,value:l,onChange:g=>_(g.target.value),placeholder:"URL, excerpt, or background (optional)",rows:2,style:Ar}))),React.createElement("div",{className:"wb-input-bay"},React.createElement(be,{label:"Optional email for follow-up"},React.createElement("input",{className:Ee,type:"email",value:u,onChange:g=>f(g.target.value),placeholder:"you@example.com (optional)",autoComplete:"email",style:Un}))),b?React.createElement(Lr,{candidate:b}):null,React.createElement("div",{className:"wb-action-row"},React.createElement(I,{kind:"primary",disabled:!v,onClick:D},m?"Submitting\u2026":"Submit Investigation")))):e==="reader-secondary"?React.createElement("section",{id:"wb-suggest-module",className:"wb-suggest-module is-collapsed is-reader-secondary","aria-labelledby":"wb-suggest-heading"},React.createElement("div",{className:"wb-flow-module wb-flow-module--suggest"},React.createElement("h2",{id:"wb-suggest-heading",className:"wb-suggest-module__heading"},"Suggest an Investigation"),React.createElement("p",{className:"wb-suggest-module__lead"},"Have a case we should inspect? Send it."),React.createElement("div",{className:"wb-action-row wb-suggest-cta-row"},React.createElement(I,{kind:"ghost",small:!0,onClick:()=>n(!0)},"Suggest")))):React.createElement("section",{id:"wb-suggest-module",className:"wb-suggest-module is-collapsed","aria-labelledby":"wb-suggest-heading"},React.createElement("div",{className:"wb-flow-module wb-flow-module--suggest"},React.createElement("p",{className:"wb-suggest-module__eyebrow"},"Field contribution"),React.createElement("h2",{id:"wb-suggest-heading",className:"wb-suggest-module__heading"},"Suggest an Investigation"),React.createElement("p",{className:"wb-suggest-module__lead"},"Help expand the archive."),React.createElement("p",{className:"wb-suggest-module__support"},"Submit a topic, claim, or behavior pattern that may deserve inspection."),React.createElement("div",{className:"wb-action-row wb-suggest-cta-row"},React.createElement(I,{kind:"primary",onClick:()=>n(!0)},"Suggest an investigation \u2192"))))}var Rr={idle:"Paste an answer to inspect it.",needQuestion:"Add the question you asked.",ready:"Let's see what might be missing\u2026",inspecting:"Reading the answer\u2026",result:"Inspection complete.",degraded:"The Reader didn't run."},Sr=["Reading the answer\u2026","Checking what might be missing\u2026","Still reading. Long answers take longer."],$n={full:"NOTHING FLAGGED",partial:"SOMETHING TO CHECK",thin:"DEFLECTION FLAGGED"},Mn={full:"This inspection surfaced no omission candidates.",partial:"This inspection surfaced candidates. They are listed below.",thin:"This inspection surfaced a Deflection signal: the answer went around the question rather than at it."};function ki({state:e}){let[t,n]=p(0);z(()=>{if(e!=="inspecting"){n(0);return}let r=window.setInterval(()=>{n(s=>Math.min(s+1,Sr.length-1))},1100);return()=>window.clearInterval(r)},[e]);let a=e==="inspecting"?Sr[t]:Rr[e]||Rr.idle;return React.createElement("div",{className:`wb-reader-v2__status-wrap is-${e}`,role:"status","aria-live":"polite"},React.createElement("span",{className:"wb-reader-v2__status-dot","aria-hidden":"true"}),React.createElement("p",{className:`wb-reader-v2__status is-${e}`},a))}function Mr(e){if(e!=null&&e.reason)return String(e.reason).replace(/^read_/,"");let n=((e==null?void 0:e.the_read)||"").match(/\(([a-z_]+)\)/i);return n?n[1]:""}function Fr(e){let t=Mr(e).toLowerCase();return rn(t)?an:["no_key","disabled","bad_json"].includes(t)?"Reader temporarily unavailable \u2014 showing fallback check.":"Reader unavailable \u2014 showing fallback check."}function Ht(){return"The full Reader is unavailable. Your question and answer are preserved above \u2014 this is not a full inspection."}function qr({mode:e,sel:t,result:n}){return(n==null?void 0:n.source)==="fallback"?"Fallback check":(n==null?void 0:n.source)!=="agent"?"Reader":e==="guided"&&(t!=null&&t.recordName)?`Reader agent \xB7 ${t.recordName}`:"Reader agent \xB7 Custom answer"}function Br(e){if((e==null?void 0:e.source)==="fallback")return["This inspection did not run.",Fr(e),"",Ht()].join(`
