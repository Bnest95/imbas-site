...
(()=>{var{useState:l,useEffect:J,useRef:z}=React,p={bg:"#1E1815",bgRaise:"#352A24",bgSunk:"#140E0C",text:"#F2E8DC",textDim:"#B9A893",textFaint:"#8C7C6B",accent:"#DE6F38",accentDim:"#C85830",accentSoft:"#F08F58",line:"rgba(242, 232, 220, 0.15)",lineControl:"rgba(248, 168, 102, 0.28)",good:"#9BAE7E"},Q="'Fraunces', Georgia, serif",M="'Inter', ui-sans-serif, system-ui, sans-serif",P="'JetBrains Mono', ui-monospace, monospace",Qe="@import url('https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400..500&family=Inter:wght@400;500&family=JetBrains+Mono:wght@400;500&display=swap');",O="wb-input wb-focus",Ze=`
