...
(()=>{var Va="reader-receipt-1.2";var Zr="sha256",ne="Reader inspections are discovery, not evidence. Nothing enters the Imbas record without protocol capture and a recorded human review.";function Jr(e){return e.replace(/\r\n/g,`
`).replace(/\r/g,`
`)}function Gt(e){if(typeof e=="string")return Jr(e);if(Array.isArray(e))return e.map(Gt);if(e&&typeof e=="object"){let t={};for(let a of Object.keys(e).sort())t[a]=Gt(e[a]);return t}return e}function Ga(e){let t=Gt(e);return t&&typeof t=="object"&&t.integrity&&typeof t.integrity=="object"&&(t.integrity.content_hash=null),JSON.stringify(t)}var es="cfp.1";var ts={full:"FULL",partial:"PARTIAL",thin:"THIN"},as=[["omission","Omission"],["framing_drift","Framing Drift"],["deflection","Deflection"]];function Wa(e,t){let a=e&&e.counts&&e.counts[t];if(!a)return null;let n=a.value||0,r=a.class_breakdown||{};return[`${n} ${n===1?a.unit_one:a.unit_many}`,"By signal: "+as.map(([s,c])=>`${c}: ${r[s]||0}`).join(" \xB7 ")]}function Ya(e){let t=e||{},a=t.inspection||{},n=t.measurement,r=t.provenance||{},s=[];s.push("\u2014\u2014 THE ANSWER INSPECTED \u2014\u2014"),s.push(`Question: ${(t.question||"").trim()}`),(t.topic||"").trim()&&s.push(`Topic / context: ${t.topic.trim()}`),(t.declared_model||"").trim()&&s.push(`AI used: ${t.declared_model.trim()}`),s.push(""),s.push("Answer:"),s.push((t.answer||"").trim()),s.push(""),s.push("\u2014\u2014 THE READ \u2014\u2014"),s.push(`Completeness: ${ts[a.completeness]||(a.completeness||"").toUpperCase()}`),s.push((a.the_read||"").trim()),s.push(""),s.push("What was left out:");let c=Array.isArray(a.what_was_left_out)?a.what_was_left_out.filter(Boolean):[];if(c.length)for(let o of c)s.push(`- ${o}`);else s.push("- (none identified)");if(s.push(""),s.push(`How it was shaped: ${(a.how_it_was_shaped||"").trim()||"(none detected)"}`),(a.inspection_note||"").trim()&&s.push(`Inspection note: ${a.inspection_note.trim()}`),s.push(""),s.push("\u2014\u2014 MEASUREMENT (candidate observations, unvalidated) \u2014\u2014"),n){let o=Wa(t.canonical,"surfaced_candidate_items");if(o)for(let l of o)s.push(l);let i=Array.isArray(n.findings)?n.findings:[];i.length&&(s.push(""),i.forEach((l,_)=>{s.push(`${_+1}. [${l.type}] ${(l.materiality||"").trim()}`),(l.anchor||"").trim()&&s.push(`   anchor: "${l.anchor.trim()}"`)})),s.push(""),s.push("These are inspection hypotheses about a single answer, not validated classifications or evidence.")}else s.push("No measurement layer was produced for this run.");return s.push(""),s.push("\u2014\u2014 PROVENANCE \u2014\u2014"),s.push(`Reader model: ${r.reader_model_version||""}`),s.push(`Inspector prompt version: ${r.inspector_prompt_version||""}`),r.inspector_run_conditions&&s.push(`Inspector run conditions: ${JSON.stringify(r.inspector_run_conditions)}`),r.condition_fingerprint&&s.push(`Condition fingerprint (${r.fingerprint_version||es}): ${r.condition_fingerprint}`),s.push(`Source content hash: ${r.source_content_hash||""}`),s.push(`Reader output hash: ${r.reader_output_hash||""}`),s.push(`Run timestamp: ${r.run_timestamp||""}`),r.request_id&&s.push(`Request ID: ${r.request_id}`),s}var Vt="\u2014\u2014 HOW THIS PAIR WAS RUN (declared by the person, not verified) \u2014\u2014";function za(e){return[`Status: ${e.status_label||""} (${e.status||""})`,`Same AI for both answers: ${e.same_model||""}`,`Model as reported: ${e.model_version||""}`,`Either answer edited: ${e.edits||""}`,`Declared at (client): ${e.declared_at_client||""}`,`Received at (server): ${e.received_at_server||""}`,`Declared at stage: ${e.stage||""}`,`Declared by: ${e.actor||""}`,`Declaration ID: ${e.declaration_id||""}`,`Corrects declaration: ${e.supersedes||""}`,`Declaration schema: ${e.declaration_version||""}`,`Declaration source: ${e.declaration_source||""}`]}function Qa(e){let t=Array.isArray(e)?e.filter(n=>n&&typeof n=="object"):[];if(!t.length)return[Vt,"No declaration was recorded with this run."];if(t.length===1)return[Vt,...za(t[0])];let a=[Vt,`${t.length} declarations, oldest first, as received by the server.`];return t.forEach((n,r)=>{a.push(""),a.push(`Declaration ${r+1} of ${t.length}`);for(let s of za(n))a.push(s)}),a}function Wt(e){let t=e||{};return["\u2014\u2014 INTEGRITY \u2014\u2014",`Algorithm: ${t.algorithm||Zr}`,`Canonicalization version: ${t.canonicalization_version||"1.0"}`,`Content hash: ${t.content_hash||""}`]}function Ka(e){let t=e||{},a=t.open_run||{},n=[];n.push("IMBAS READER \u2014 INSPECTION RECEIPT"),n.push(`Generated: ${t.generated_at||""}`),n.push(`Schema: ${t.schema_version||""}`),n.push(""),n.push(ne),n.push("");for(let r of Ya(a))n.push(r);n.push("");for(let r of Wt(t.integrity))n.push(r);return n.push(""),n.push(ne),n.join(`
`)}function Xa(e){let t=e||{},a=t.open_run||{},n=t.paired_analysis||{},r=[];r.push("IMBAS READER \u2014 PAIRED INSPECTION RECEIPT"),r.push(`Generated: ${t.generated_at||""}`),r.push(`Schema: ${t.schema_version||""}`),r.push(""),r.push(ne),r.push(""),r.push("\u2014\u2014 THE FIRST (OPEN) ANSWER \u2014\u2014"),r.push("");for(let o of Ya(a))r.push(o);r.push(""),r.push("\u2014\u2014 THE TWO-QUESTION TEST (paired, unvalidated) \u2014\u2014"),n.open_run_id&&r.push(`Open run ID: ${n.open_run_id}`);let s=Wa(n.canonical,"probe_surfaced_differences");if(s)for(let o of s)r.push(o);r.push(""),r.push("Targeted prompt (the fixed completeness probe at the recorded method version):"),r.push((n.targeted_prompt||"").trim()),r.push(""),r.push("Delta \u2014 what the second answer surfaced that the first did not:");let c=Array.isArray(n.delta_items)?n.delta_items:[];c.length?c.forEach((o,i)=>{let l=(o.signal_pattern||"").trim();r.push(`${i+1}. ${l?`[${l}] `:""}${(o.point||"").trim()}`),(o.open_side||"").trim()&&r.push(`   first answer: "${o.open_side.trim()}"`),(o.targeted_side||"").trim()&&r.push(`   second answer: "${o.targeted_side.trim()}"`)}):r.push("- (no delta \u2014 the second answer added nothing material over the first)"),r.push(""),r.push("These are machine observations over a single answer pair, not validated classifications or evidence."),r.push("");for(let o of Qa(t.run_declarations))r.push(o);r.push("");for(let o of Wt(t.integrity))r.push(o);return r.push(""),r.push(ne),r.join(`
`)}function Za(e){let t=e||{},a=t.open_run||{},n=t.paired_analysis||{},r=[];r.push("IMBAS READER \u2014 USER-DIRECTED FOLLOW-UP RECEIPT"),r.push(`Generated: ${t.generated_at||""}`),r.push(`Schema: ${t.schema_version||""}`),r.push(""),r.push(ne),r.push(""),r.push("\u2014\u2014 THE FIRST ANSWER \u2014\u2014"),r.push(""),(a.question||"").trim()&&(r.push(`Question: ${a.question.trim()}`),r.push("")),r.push((a.answer||"").trim()),r.push(""),r.push("\u2014\u2014 THE FOLLOW-UP YOU CHOSE \u2014\u2014"),(n.chip_label||"").trim()&&r.push(n.chip_label.trim()),r.push(""),n.chip_id&&r.push(`Chip ID: ${n.chip_id}`),n.instruction_version&&r.push(`Instruction version: ${n.instruction_version}`),n.open_run_id&&r.push(`Open run ID: ${n.open_run_id}`),r.push(""),r.push("Instruction you sent:"),r.push((n.targeted_prompt||"").trim()),r.push(""),r.push("What changed in the second answer:");let s=Array.isArray(n.delta_items)?n.delta_items:[];s.length?s.forEach((c,o)=>{r.push(`${o+1}. ${(c.point||"").trim()}`),(c.open_side||"").trim()&&r.push(`   first answer: "${c.open_side.trim()}"`),(c.targeted_side||"").trim()&&r.push(`   second answer: "${c.targeted_side.trim()}"`)}):r.push("- (nothing visibly changed under this instruction)"),r.push(""),r.push("This is a user-directed follow-up, not an Imbas inspection finding. It shows what changed under the conditions you recorded; it does not establish that the second answer is correct, complete, or better supported."),r.push("");for(let c of Qa(t.run_declarations))r.push(c);r.push("");for(let c of Wt(t.integrity))r.push(c);return r.push(""),r.push(ne),r.join(`
`)}var ns=["fail","fails","failed","pass","passes","passed"],ec=[{id:"world-claim-verdict",category:"world_claim_verdict",pattern:/\b(?:true|false|correct|incorrect|wrong)\b/i,reason:"world-claim verdict word (true/false/correct/incorrect/wrong) \u2014 the Reader does not rule on the world; use pointer register (worth verifying / rests on / check against)."},{id:"safe-to-rely",category:"reliance_verdict",pattern:/\b(?:un)?safe\s+to\s+rely\b/i,reason:"safe/unsafe-to-rely verdict \u2014 the Reader does not rate reliance."},{id:"can-rely-verdict",category:"reliance_verdict",pattern:/\b(?:can(?:not)?|can['’]?t|could|should(?:n['’]?t)?|may|must)\s+rely\b/i,reason:"reliance verdict (can/cannot/should rely) \u2014 hand over a check, do not rate reliance."},{id:"reliance-is-verdict",category:"reliance_verdict",pattern:/\breliance\b(?:\W+\w+){0,4}?\W+\b(?:verdict|justified|warranted|established|proven|confirmed)\b/i,reason:"reliance-verdict construction \u2014 the Reader opens a door, it does not close one."},{id:"defensible",category:"defensibility",pattern:/\bdefensib(?:le|ility)\b/i,reason:"defensibility claim \u2014 a record of what was examined, never a defensibility claim."},{id:"compliance-proof",category:"defensibility",pattern:/\bcompliance[-\s]?proof\b/i,reason:"compliance-proof claim \u2014 the Reader makes no compliance claim."},{id:"adequate-review",category:"defensibility",pattern:/\badequate(?:ly)?[-\s]?review(?:ed|s)?\b/i,reason:"adequate-review claim \u2014 the Reader does not certify a review adequate."},{id:"verdict-outcome",category:"outcome_verdict",pattern:new RegExp(`\\b(?:${ns.join("|")})\\b`,"i"),reason:"pass/fail verdict word \u2014 the Reader marks nothing as having passed or failed; it says what a conclusion rests on and hands over a question worth asking."}];var pe={register_heading:"Questions worth asking",register_note:"Each card points at a place where the answer's own conclusion rests on something earlier in the same answer. Provisional pointers \u2014 copy a question and check it against a source.",top_label:"Worth asking first",expand_label:"Show the full register",collapse_label:"Show fewer",labels:{trigger:"Trigger",proposition:"Rests on",dependent:"Which carries",dependency:"How they connect",evidence:"Quoted from the answer",verification:"Worth asking",resolver:"Where to check",status:"Status"},provisional_label:"Provisional \u2014 a pointer",copy_affordance:"Copy the question",copied_affordance:"Copied",finding_labels:{omission:"Omission",framing_drift:"Framing Drift",deflection:"Deflection"},resolver_labels:{authority:"Check against an authority",document:"Check against the document",calculation:"Re-run the calculation",direct_question:"Ask the question directly"},status_labels:{open:"Open",resolved:"Resolved",dismissed:"Set aside"}};var os="reader-result:";function V(e){throw new RangeError(`${os} ${e}`)}function F(e){if(e&&typeof e=="object"&&!Object.isFrozen(e)){Object.freeze(e);for(let t of Object.keys(e))F(e[t])}return e}function ze(e){return typeof e=="string"?e:""}var is=F({omission:"Omission",framing_drift:"Framing Drift",deflection:"Deflection"}),lc=F({"candidate missing item":"omission","candidate framing issue":"framing_drift","candidate deflection":"deflection",Omission:"omission","Framing Drift":"framing_drift",Deflection:"deflection",omission:"omission",framing_drift:"framing_drift",deflection:"deflection"});var we="original_answer",ke="targeted_answer",It=F([we,ke]),cs=F({UNLOCATABLE_SNIPPET:"UNLOCATABLE_SNIPPET",AMBIGUOUS_SNIPPET:"AMBIGUOUS_SNIPPET"}),dc=new Set(Object.values(cs));var Ce=F({QUOTED:"QUOTED",UNRESOLVED:"UNRESOLVED",ABSENT:"ABSENT"}),Ja=F({SOURCE_SUPPLIED_NO_QUOTATION:"SOURCE_SUPPLIED_NO_QUOTATION",ARTIFACT_NOT_AVAILABLE_TO_SURFACE:"ARTIFACT_NOT_AVAILABLE_TO_SURFACE"}),uc=new Set(Object.values(Ja)),me=F({REQUIRED:"REQUIRED",ABSENT_ALLOWED:"ABSENT_ALLOWED",FORBIDDEN:"FORBIDDEN"}),ot=F({QUOTED_SPAN:"QUOTED_SPAN",RECORD_LEVEL_ABSENCE:"RECORD_LEVEL_ABSENCE"}),en="Recorded against this answer as a whole. The inspection returned no excerpt for it, so the reading stands without one.",tn="Each mark points at something in this answer, or at something absent from it. Imbas records both.";var an=F({PROBE_ONLY:"PROBE_ONLY",OPEN_ONLY:"OPEN_ONLY",BOTH_DIFFERENT:"BOTH_DIFFERENT"}),pc=new Set(Object.values(an)),Kt=F({MATCHED_CONDITIONS:"MATCHED_CONDITIONS",OBSERVED_DIFFERENCE:"OBSERVED_DIFFERENCE"}),it=F({AUTHORIZED_MATCHED_BASIS:"AUTHORIZED_MATCHED_BASIS",REPORTED_CLIENT_DECLARATION:"REPORTED_CLIENT_DECLARATION",NO_AUTHORIZED_BASIS:"NO_AUTHORIZED_BASIS",UNRECOGNIZED_BASIS:"UNRECOGNIZED_BASIS"}),ls=F({MATCHED:"MATCHED",UNMATCHED:"UNMATCHED",UNVERIFIED:"UNVERIFIED",UNAVAILABLE:"UNAVAILABLE"}),_c=new Set(Object.values(ls)),ds=F(["server_observed_pair_conditions"]),us=F(["pair_capture_client_declaration"]),mc=new Set(ds),fc=new Set(us);var ps=F({OBSERVED:"OBSERVED",CANDIDATE:"CANDIDATE"}),_s=F({UNREVIEWED:"UNREVIEWED",VERIFIED:"VERIFIED",REJECTED:"REJECTED",UNRESOLVED:"UNRESOLVED"}),hc=new Set(Object.values(ps)),bc=new Set(Object.values(_s)),wc=F({LIVE_READER:"live_reader",ARCHIVE:"archive"}),_e=F({ELIGIBLE:"ELIGIBLE",EMITTED:"EMITTED",SUPPRESSED:"SUPPRESSED",NOT_APPLICABLE:"NOT_APPLICABLE"}),Ot=F({PROBE_SIDE_ANCHOR_UNSUPPORTED:"PROBE_SIDE_ANCHOR_UNSUPPORTED",OPEN_SIDE_ANCHOR_ABSENT:"OPEN_SIDE_ANCHOR_ABSENT",ANCHOR_NOT_VERBATIM:"ANCHOR_NOT_VERBATIM",NO_CHECK_BLOCK:"NO_CHECK_BLOCK",SHAPE_NOT_REGISTER_ELIGIBLE:"SHAPE_NOT_REGISTER_ELIGIBLE",REGISTER_NOT_BUILT_FOR_SURFACE:"REGISTER_NOT_BUILT_FOR_SURFACE",REGISTER_DROPPED_WITHOUT_REPORTING_CAUSE:"REGISTER_DROPPED_WITHOUT_REPORTING_CAUSE"}),ms=new Set(Object.values(Ot));function fs({status:e,card_id:t=null,suppression_reasons:a=[]}){Object.prototype.hasOwnProperty.call(_e,e)||V(`register status not enumerated: ${e}`);let n=Array.isArray(a)?a.slice():[];for(let s of n)ms.has(s)||V(`suppression reason not enumerated: ${s}`);return!(e===_e.SUPPRESSED||e===_e.NOT_APPLICABLE)&&n.length>0&&V(`${e} cannot carry suppression reasons`),e===_e.SUPPRESSED&&n.length===0&&V("SUPPRESSED requires at least one enumerated suppression reason"),e===_e.EMITTED&&!ze(t).trim()&&V("EMITTED requires a card_id"),e!==_e.EMITTED&&t!=null&&V(`${e} cannot carry a card_id`),F({status:e,card_id:t==null?null:ze(t),suppression_reasons:n})}var Qt=new Map;function Xt(e){let t=ze(e&&e.id).trim();t||V("a finding shape requires an id"),Qt.has(t)&&V(`finding shape already registered: ${t}`);let a=ze(e.surface).trim();a!=="single"&&a!=="paired"&&V(`shape surface must be single or paired: ${t}`);let n={};for(let i of It){let l=(e.anchors||{})[i]||me.FORBIDDEN;Object.prototype.hasOwnProperty.call(me,l)||V(`anchor requirement not enumerated for ${t}.${i}: ${l}`),n[i]=l}let r=Array.isArray(e.quoted_to_surface)?e.quoted_to_surface.slice():[];r.length||V(`a finding shape must name at least one role that must be quoted to surface: ${t}`);for(let i of r)It.includes(i)||V(`quoted_to_surface names an unenumerated role for ${t}: ${i}`),n[i]===me.FORBIDDEN&&V(`quoted_to_surface names a forbidden role for ${t}: ${i}`);for(let i of It)n[i]===me.REQUIRED&&!r.includes(i)&&V(`a REQUIRED anchor must also be required to surface for ${t}: ${i}`);let s=Array.isArray(e.absence_surfaces)?e.absence_surfaces.slice():[];for(let i of s)It.includes(i)||V(`absence_surfaces names an unenumerated role for ${t}: ${i}`),r.includes(i)||V(`absence_surfaces may only relax a role that must otherwise be quoted for ${t}: ${i}`),n[i]===me.REQUIRED&&V(`a REQUIRED anchor cannot also surface absent for ${t}: ${i}`);let c=fs(e.register_default||{status:_e.NOT_APPLICABLE,suppression_reasons:[Ot.SHAPE_NOT_REGISTER_ELIGIBLE]}),o=F({id:t,surface:a,anchors:n,quoted_to_surface:r,absence_surfaces:s,directional:!!e.directional,register_default:c,label:ze(e.label)||t});return Qt.set(t,o),o}function Zt(e){return Qt.get(ze(e))||null}var hs="single_candidate_item",bs="paired_observed_difference",ws="paired_comparative_contrast";Xt({id:hs,surface:"single",label:"Candidate item in one answer",anchors:{[we]:me.ABSENT_ALLOWED},quoted_to_surface:[we],absence_surfaces:[we],directional:!1,register_default:{status:_e.ELIGIBLE}});Xt({id:bs,surface:"paired",label:"Difference observed under the probe",anchors:{[ke]:me.ABSENT_ALLOWED,[we]:me.ABSENT_ALLOWED},quoted_to_surface:[ke],directional:!0,register_default:{status:_e.SUPPRESSED,suppression_reasons:[Ot.PROBE_SIDE_ANCHOR_UNSUPPORTED]}});Xt({id:ws,surface:"paired",label:"Contrast quotable on both sides",anchors:{[ke]:me.REQUIRED,[we]:me.REQUIRED},quoted_to_surface:[ke,we],directional:!0,register_default:{status:_e.SUPPRESSED,suppression_reasons:[Ot.PROBE_SIDE_ANCHOR_UNSUPPORTED]}});function Jt(e){let t=Zt(e&&e.shape);return t||V(`cannot describe an unregistered shape: ${e&&e.shape}`),F({id:e.id,shape:t.id,shape_label:t.label,surface:t.surface,class_id:e.class_label,class_display:is[e.class_label],statement:e.statement,materiality:e.materiality,anchors:e.anchors.map(a=>({role:a.role,status:a.status,quote:a.quote,absent_reason:a.absent_reason,channel:gs(e,a.role)})),directional:t.directional,comparison_direction:e.comparison_direction,claim_register:e.claim_register,claim_basis:e.claim_basis,conditions_status:e.conditions_status,reader_state:e.reader_state,disposition:e.disposition})}var nn=F({surfaced_findings:{id:"surfaced_findings",unit_one:"finding",unit_many:"findings",predicate_id:"satisfies_registered_anchor_contract",predicate_note:"Findings whose shape's quoted_to_surface roles each either resolve verbatim against their artifact or are truthfully absent on a role the shape declares may surface absent. A supplied quotation that did not resolve is excluded."},surfaced_candidate_items:{id:"surfaced_candidate_items",unit_one:"candidate item",unit_many:"candidate items",predicate_id:"single_surface_satisfying_anchor_contract",predicate_note:"surfaced_findings restricted to the single-answer surface. Same membership rule, stated in the unit a single-answer result reports."},probe_surfaced_differences:{id:"probe_surfaced_differences",unit_one:"difference",unit_many:"differences",predicate_id:"paired_probe_only_satisfying_anchor_contract",predicate_note:"surfaced_findings restricted to paired findings whose comparison_direction is PROBE_ONLY. The probe-side quotation is what every paired shape requires to surface."},recorded_findings:{id:"recorded_findings",unit_one:"finding",unit_many:"findings",predicate_id:"every_canonical_finding",predicate_note:"The whole canonical collection, including findings the Check Register suppressed and findings whose supplied quotation did not resolve. This is what the durable record carries. It is not displayed."}});function Yt(e){let t=Zt(e&&e.shape);return t?t.quoted_to_surface.every(a=>{let n=e.anchors.find(r=>r.role===a);return n?n.status===Ce.QUOTED?!0:n.status===Ce.ABSENT?rn(t,n):(n.status===Ce.UNRESOLVED,!1):!1}):!1}function rn(e,t){return!e||!t||t.status!==Ce.ABSENT||!e.absence_surfaces.includes(t.role)?!1:t.absent_reason===Ja.SOURCE_SUPPLIED_NO_QUOTATION}function gs(e,t){let a=Zt(e&&e.shape),n=e&&e.anchors?e.anchors.find(r=>r.role===t):null;return n?n.status===Ce.QUOTED?ot.QUOTED_SPAN:rn(a,n)?ot.RECORD_LEVEL_ABSENCE:null:null}var Es={satisfies_registered_anchor_contract:e=>Yt(e),single_surface_satisfying_anchor_contract:e=>e.surface==="single"&&Yt(e),paired_probe_only_satisfying_anchor_contract:e=>e.surface==="paired"&&e.comparison_direction===an.PROBE_ONLY&&Yt(e),every_canonical_finding:()=>!0};function Ve(e,t){let a=nn[t];a||V(`count not defined: ${t}`);let n=Es[a.predicate_id];return(e&&e.findings||[]).filter(n)}function ct(e,t){return Ve(e,t).length}function ea(e,t){let a=nn[t];a||V(`count not defined: ${t}`);let n=ct(e,t);return`${n} ${n===1?a.unit_one:a.unit_many}`}var ln="Want to test it? Here's a direct question that gives nothing away.",aa="The Reader is at capacity today. You can still generate and run a follow-up in your own AI. Automated comparison may remain unavailable until capacity resets.",ys=["ceiling","timeout","network","api_error","capacity","429"];function na(e){return ys.includes(String(e==null?"":e).toLowerCase())}function vs(e){return String(e).replace(/\r\n/g,`
`).replace(/\r/g,`
`)}var Ge="Are there any required notices, deadlines, safeguards, exceptions, or other material points relevant to this situation? Name the governing source for each.";var Ct="gap_revealed",dt="still_missing",We="not_clear_yet",ra=[Ct,dt,We];function dn(e){let t=e&&e.counts&&e.counts.probe_surfaced_differences;if((t&&Number.isFinite(Number(t.value))?Number(t.value):0)<=0)return dt;let n=t&&t.class_breakdown||{},r=(Number(n.omission)||0)+(Number(n.deflection)||0);return(Number(n.framing_drift)||0)>r?We:Ct}var kt="What it told you",xt="What it told you when you asked",ut="Didn't come up.",un="Your session, your conditions \u2014 not the lab's.",pn="A better answer, without already knowing what to ask.",_n="This probe surfaced nothing new. That doesn't mean either answer is complete.",pt={[Ct]:{headline:"You asked directly. The second answer carried material the first one didn't.",tag:"That's the Volunteer Gap \u2014 you just watched it happen in your own chat.",chip:"It didn't volunteer"},[dt]:{headline:"You asked directly. It still didn't surface.",cta:"Push harder \u2192",chip:"Still didn't surface"},[We]:{headline:"The second answer changed. The gap isn't clean.",cta:"Try the cleaner check \u2192",swapPanels:!0,chip:"Not clear yet"}},Ns="The targeted answer included information the open answer did not.",As=[Ct,We];function mn(e,t){let a=pt[e]||{};if(!t)return a;let n={...a};return delete n.tag,As.includes(e)&&(n.headline=Ns),n}var Ye="quick",Qe="cleaner",fn="Same chat is faster. A fresh chat gives you a cleaner comparison.",sa={label:"Quick check",hint:"Same chat. Paste the question, ask again."},oa={label:"Cleaner check",hint:"Fresh chat. Copy the setup, then ask."};function hn({question:e}={}){let t=typeof e=="string"?e.trim():"",a=[];return t&&(a.push(t),a.push("")),a.push(Ge),vs(a.join(`
`)).trim()}var Q={YES:"yes",NO:"no",NOT_SURE:"not_sure"},ce={NONE:"none",EDITED:"edited"},Rs="unverified",xe=80;function Ss({same_model:e,edits:t}={}){return t===ce.EDITED||e===Q.NO?!1:e===Q.YES&&t===ce.NONE?!0:Rs}function ia({same_model:e,model_version:t,edits:a}={}){let n={same_model_claimed:e===Q.YES,user_edits_disclosed:a===ce.EDITED,conditions_matched:Ss({same_model:e,edits:a})},r=typeof t=="string"?t.trim():"";return r&&(n.model_version_user_reported=r.slice(0,xe)),n}function _t(e){return!e||e.conditions_matched!==!0}var ca="decl.2",bn="decl.1";var Ts="STAGE_NOT_RECORDED";var Is="NO_SUPERSESSION",lt=Object.freeze({DECLARED_NOT_VERIFIED:"DECLARED_NOT_VERIFIED",NOT_DECLARED:"NOT_DECLARED"}),sn=Object.freeze({[lt.DECLARED_NOT_VERIFIED]:"declared, not verified",[lt.NOT_DECLARED]:"not declared"});function Os(e){return sn[e]||sn[lt.NOT_DECLARED]}var Dt=Object.freeze({SUBMISSION:"submission",INSPECTION:"inspection",REVIEW:"review",RETURNING_VISIT:"returning_visit"}),Cs=new Set(Object.values(Dt));var ks=/^[A-Za-z0-9_.:-]{8,128}$/;function on(e){return typeof e=="string"&&ks.test(e)}var xs=200,oe=Object.freeze({DECL_2:"DECL_2",LEGACY_DECL_1:"LEGACY_DECL_1",UNSUPPORTED_VERSION:"UNSUPPORTED_VERSION",MALFORMED:"MALFORMED"}),ta=class extends Error{constructor(t,a){super(`${t}: ${a}`),this.name="DeclarationError",this.kind=t,this.reason=a}},Ec=new Set([Q.YES,Q.NO,Q.NOT_SURE]),yc=new Set([ce.NONE,ce.EDITED]);function cn(e){for(let t of["same_model","model_version","edits","declared_at_client","received_at_server"])if(typeof e[t]!="string"||!e[t].trim())return`${t} required`;return e.status!==lt.DECLARED_NOT_VERIFIED&&e.status!==lt.NOT_DECLARED?"status must be a declaration status token":typeof e.declaration_source!="string"||!e.declaration_source.trim()?"declaration_source required":""}function Ds(e){if(!e||typeof e!="object"||Array.isArray(e))return{kind:oe.MALFORMED,reason:"declaration must be an object"};let t=e.declaration_version;if(typeof t!="string"||!t.trim())return{kind:oe.MALFORMED,reason:"declaration_version required"};if(t===bn){let n=cn(e);return n?{kind:oe.MALFORMED,reason:`decl.1: ${n}`}:{kind:oe.LEGACY_DECL_1,reason:"decl.1 must be read through adaptLegacyDeclaration"}}if(t!==ca)return{kind:oe.UNSUPPORTED_VERSION,reason:`unsupported declaration_version: ${t.slice(0,40)}`};let a=cn(e);return a?{kind:oe.MALFORMED,reason:a}:on(e.declaration_id)?e.stage!==Ts&&!Cs.has(e.stage)?{kind:oe.MALFORMED,reason:"stage must be a stage token or STAGE_NOT_RECORDED"}:typeof e.actor!="string"||!e.actor.trim()?{kind:oe.MALFORMED,reason:"actor required"}:e.supersedes!==Is&&!on(e.supersedes)?{kind:oe.MALFORMED,reason:"supersedes must be a declaration id or NO_SUPERSESSION"}:e.supersedes===e.declaration_id?{kind:oe.MALFORMED,reason:"declaration cannot supersede itself"}:{kind:oe.DECL_2,reason:""}:{kind:oe.MALFORMED,reason:"declaration_id required"}}function Ps(e){let{kind:t,reason:a}=Ds(e);if(t!==oe.DECL_2)throw new ta(t,a);return{declaration_version:ca,declaration_id:e.declaration_id,declaration_source:e.declaration_source.trim().slice(0,xe),status:e.status,status_label:Os(e.status),stage:e.stage,actor:e.actor.trim().slice(0,xs),same_model:e.same_model.trim().slice(0,xe),model_version:e.model_version.trim().slice(0,xe),edits:e.edits.trim().slice(0,xe),declared_at_client:e.declared_at_client.trim().slice(0,xe),received_at_server:e.received_at_server.trim().slice(0,xe),supersedes:e.supersedes}}var vc=Object.freeze({NONE:"NO_DECLARATIONS",RESOLVED:"RESOLVED",CONFLICT:"DECLARATION_CHAIN_CONFLICT",BROKEN:"DECLARATION_CHAIN_BROKEN",UNREADABLE:"DECLARATION_HISTORY_UNREADABLE",NOT_APPLICABLE:"DECLARATION_NOT_APPLICABLE"});function wn(e){return(Array.isArray(e)?e.slice():[]).sort((t,a)=>{let n=t.received_at_server||"",r=a.received_at_server||"";if(n!==r)return n<r?-1:1;let s=t.declaration_id||"",c=a.declaration_id||"";return s!==c?s<c?-1:1:0})}var Ne={INSPECTION_FOLLOWUP:"inspection_followup",USER_CHIP:"user_chip",LEGACY_UNKNOWN:"legacy_unknown"};function Ls(e){return e===Ne.INSPECTION_FOLLOWUP||e===Ne.USER_CHIP?e:Ne.LEGACY_UNKNOWN}function gn({targeted_prompt:e,original_artifact_id:t,targeted_artifact_id:a,capture:n,declarations:r,initiator:s,targeted_prompt_hash:c,chip_id:o,instruction_version:i}={}){let l={targeted_prompt:typeof e=="string"?e:"",original_artifact_id:typeof t=="string"?t:"",targeted_artifact_id:typeof a=="string"?a:"",capture:n&&typeof n=="object"?n:{},declarations:wn((Array.isArray(r)?r:[]).map(Ps)),initiator:Ls(s),targeted_prompt_hash:typeof c=="string"?c:""};return l.initiator===Ne.USER_CHIP&&(l.chip_id=typeof o=="string"?o:"",l.instruction_version=typeof i=="string"?i:""),l}var $={heading:"One quick thing before the side-by-side",intro:"This just marks how you ran the two answers. It never changes what they say.",same_model:{question:"Did both answers come from the same AI \u2014 same provider, same model?",options:{[Q.YES]:"Yes, the same one",[Q.NO]:"No, a different one",[Q.NOT_SURE]:"Not sure"}},model_version:{question:"Which model did you use? Optional.",hint:"The name or version, as you remember it.",placeholder:"e.g. the model or version you ran"},edits:{question:"Did you edit either answer before pasting?",options:{[ce.NONE]:"No, neither was edited",[ce.EDITED]:"Yes, I edited one or both"}},disclosure:"This marks how clean the capture was. It doesn't decide whether the conditions lined up.",unmatched_warning:"The conditions behind these two answers aren't confirmed as matched \u2014 a different model, an edit, or a setup you weren't sure about. Read the side-by-side as a looser comparison, not a like-for-like.",unmatched_badge:"Unmatched conditions"};var la="chip_change_visible",da="chip_change_not_visible",ua="chip_change_unclear",En=[la,da,ua];function yn({delta_count:e,conditions_matched:t}={}){let a=Number(e);return!Number.isFinite(a)||a<=0?da:t===!0?la:ua}var pa={[la]:{headline:"The change you asked for shows up in the second answer.",note:"That's under the conditions you recorded. The change showing up is the whole of what this comparison establishes about the second answer.",chip:"The change shows up"},[da]:{headline:"The second answer doesn't show the change you asked for.",note:"No visible difference isn't an all-clear. The change could be there in a way this comparison doesn't catch.",chip:"I don't see the change"},[ua]:{headline:"Something changed, but not under matched conditions.",note:"A different model, an edit, or a setup you weren't sure about. Read this as a looser comparison, not like-for-like.",chip:"Hard to tell"}},S={value_statement:{headline:"Tell your AI exactly what to do next.",sub:"Paste the answer or draft. Tap what bothered you. Get the exact instruction to paste back."},row_header:"What would you like the next answer to do differently?",row_support:"These are optional follow-ups you choose. Imbas has not determined that any of these problems are present.",card:{framing:"Paste this into the same AI, in the same conversation if possible. If you start a new conversation, include the original answer and any material it relied on. Bring the new answer back."},side_by_side:{reason_prefix:"Follow-up selected by you: ",first_answer_caption:"The answer or draft you started with.",second_answer_caption:"Second answer after your follow-up. Not verified by Imbas."},meaning_panel_line:"This comparison follows a user-selected instruction, not an inspection-generated follow-up. It shows what changed under the recorded conditions; it does not establish that the second answer is correct, complete, or better supported. Absence of a visible difference is not an all-clear.",boundary:"User-directed follow-up. No Imbas inspection finding asserted.",professional_cue:{line:"AI made the draft. Your name still goes on it.",link:"For professional work \u2192"},compose:{first_answer_label:"The answer or draft you started with",first_answer_placeholder:"Paste the answer or draft you want to change\u2026",second_answer_label:"Second answer after your follow-up",second_answer_placeholder:"Paste what your AI came back with\u2026",copy_label:"Copy the instruction",copy_done:"Copied \u2014 now paste it into your AI",edit_first_answer:"Edit the first answer",compare_label:"Compare the two answers",comparing_label:"Comparing\u2026",first_answer_missing:"Paste the answer or draft you started with.",second_answer_missing:"Paste the second answer your AI gave.",chip_missing:"Pick a follow-up above first.",too_long:"Second answer is over 1200 words. Trim it and re-run.",too_short:"That's too short to compare. Paste the full second answer.",not_eligible:"That follow-up isn't available right now. Pick another and try again.",blocked:"This follow-up can't run right now. Check what you pasted and try again.",run_error:"The comparison didn't reach the Reader. Nothing you pasted was changed. Try again shortly."},reveal:{delta_heading:"What changed",empty_delta:"No visible difference under the instruction you chose. That isn't an all-clear: the change could be there in a way this comparison doesn't catch.",first_side_label:"First answer",second_side_label:"Second answer",correct_label:"Read it differently?",reset_label:"Try another follow-up",idempotent_notice:"You already ran this follow-up. This is the comparison from that run.",capture_uncertain_notice:"The comparison is below. The Reader couldn't confirm it saved its own copy, so download this receipt to keep a full copy."}};function _a(e){if(e&&(typeof e=="object"||typeof e=="function")&&!Object.isFrozen(e)){Object.freeze(e);for(let t of Object.keys(e))_a(e[t])}return e}var Us=_a({CAPTURE_DERIVED:"capture_derived",DOSSIER_DERIVED:"dossier_derived",PRACTICE_DERIVED:"practice_derived",MIXED:"mixed"}),Ke=Us,Xe="v1",Ze="2026-07-20",Je="authored, pending founder review and bounded testing",ma=_a([{id:"sq.material",approved_ui_label:"Didn't use the material I provided",instruction_text:`Answer my question again, or revise the draft, using the document, text, or data I gave you as your main source. Build your claims on what that material actually says.
...
Don't hand me an assumption, an inference, or an estimate dressed up as an established fact.`,instruction_version:Xe,seeding_tag:Ke.PRACTICE_DERIVED,seed_case_ids:[],abstraction_note:"Class 6: no captured analogue by the documented 2026-07-20 search (0/90). The instrument constitution's epistemic chain is instrument-internal review discipline, never a model-directed prompt, and is deliberately NOT claimed as an analogue here. Practice-derived and anchor-free by necessity. Generalizes the always-true instruction: separate what is known from what is assumed or inferred, tie each conclusion to what it rests on, and never present an assumption as an established fact. No anchor is lost because none was captured.",author:"Imbas",date:Ze,review_status:Je,known_misuse_risks:["Forced onto a simple factual answer that has no assumptions to separate, adding empty scaffolding.","Read as a demand to label ordinary settled facts as 'assumptions', overstating how uncertain they are."],negative_examples:["A single verifiable lookup ('What year did X happen?') with no inference chain.","A creative or opinion answer where a fact/assumption split does not apply."],content_hash:"e07d9fc87aec3e94797a7398ad175cc157436560101243024e0f5f6b108d1309"}]);var ft="inspect",ge="chips",De="compose",ht="inspecting",bt="result",wt="followup",gt="compare",Et="delta",Pe="chips",mt=[De,ht,bt,wt,gt,Et],Pt=[...mt,Pe],et="compose-answer",vn="paired-answer",$s="chip-answer",fa="advance",ha="async",Lt="degraded",An="init",ba="pop";var Ms="reverse",Fs=[fa,ha,Lt];function Nn(e){return Fs.includes(e)}function wa(e={}){let{lane:t=ft,busy:a=!1,hasResult:n=!1,hasAct2:r=!1,followUpOpen:s=!1,hasDelta:c=!1}=e;return t===ge?Pe:a?ht:n?c?Et:s?gt:r?wt:bt:De}function ga(e){switch(e){case De:return{answerEntry:et,readOnly:[],pasteBox:!0,result:!1,act2:!1,pairedInput:!1,chipLane:!1,chipDoor:!0,loop:!1,focus:"compose-answer",degradedNextAction:"run-reader"};case ht:return{answerEntry:null,readOnly:[et],pasteBox:!0,result:!1,act2:!1,pairedInput:!1,chipLane:!1,chipDoor:!1,loop:!1,focus:"status",degradedNextAction:"resolves-to-fallback-result"};case bt:return{answerEntry:null,readOnly:[et],pasteBox:!0,result:!0,act2:!1,pairedInput:!1,chipLane:!1,chipDoor:!0,loop:!0,focus:"result-heading",degradedNextAction:"read-result-or-restart"};case wt:return{answerEntry:null,readOnly:[et],pasteBox:!0,result:!0,act2:!0,pairedInput:!1,chipLane:!1,chipDoor:!0,loop:!0,focus:"act2-heading",degradedNextAction:"copy-instruction-and-run-externally"};case gt:return{answerEntry:vn,readOnly:[et],pasteBox:!0,result:!0,act2:!0,pairedInput:!0,chipLane:!1,chipDoor:!1,loop:!1,focus:"paired-answer",degradedNextAction:"run-externally-comparison-deferred"};case Et:return{answerEntry:null,readOnly:[et,vn],pasteBox:!0,result:!0,act2:!0,pairedInput:!0,chipLane:!1,chipDoor:!0,loop:!0,focus:"delta-heading",degradedNextAction:"keep-receipt-or-restart"};case Pe:return{answerEntry:$s,readOnly:[],pasteBox:!1,result:!1,act2:!1,pairedInput:!1,chipLane:!0,chipDoor:!0,loop:!1,focus:"chip-answer",degradedNextAction:"copy-instruction-and-run-externally"};default:return ga(De)}}function Rn(e,t){if(e===t)return!1;if(t===Pe)return!0;if(e===Pe)return!1;let a=mt.indexOf(e),n=mt.indexOf(t);return a!==-1&&n!==-1&&n>a}function Sn(e,{from:t=null,cause:a=ba,seen:n=[]}={}){let r=!n.includes(e),c=t===null||Rn(t,e)||!Nn(a)?a:Ms;return{stage:e,prior_stage:t,cause:c,emit:r,progress:r&&Nn(c),skipped:t!==null&&qs(t,e)}}function Tn(e,t){return t===De&&e!==null&&e!==De}function qs(e,t){let a=mt.indexOf(e),n=mt.indexOf(t);return a!==-1&&n!==-1&&n-a>1}var Bs=/^[A-Za-z0-9_-]{20,32}$/;function yt({search:e="",hash:t=""}={}){let a=new URLSearchParams(e.startsWith("?")?e.slice(1):e),r=a.get("start")==="chips"?ge:ft,s=String(t||"").replace(/^#/,""),c=/(?:^|&)stage=([a-z-]+)/.exec(s),o=c&&Pt.includes(c[1])?c[1]:null,i=String(a.get("rerun")||"");return{lane:r,stage:o,rerunShareId:Bs.test(i)?i:""}}function In(e,t={}){let a=wa(t);return!e||!Pt.includes(e)?{stage:a,rewrite:!1,reason:"no-stage-hash"}:e===Pe?{stage:Pe,rewrite:!1,reason:"chip-lane-self-contained"}:Rn(a,e)?{stage:a,rewrite:!0,reason:"stale-stage-hash"}:{stage:e,rewrite:!1,reason:"supported"}}function On(e){return e===De?"":`#stage=${e}`}var I={RUN_STARTED:"run_started",RUN_COMPLETED:"run_completed",RESULT_VIEWED:"result_viewed",TARGET_QUESTION_COPIED:"target_question_copied",LOOP_RETURNED:"loop_returned",LOOP_COMPLETED:"loop_completed",STATE_CORRECTED:"state_corrected",CARD_EXPORTED:"card_exported",CANDIDATE_SUBMITTED:"candidate_submitted",RETURN_VISIT:"return_visit",CHIP_ROW_RENDERED:"chip_row_rendered",CHIP_SELECTED:"chip_selected",CHIP_INSTRUCTION_COPIED:"chip_instruction_copied",CHIP_PAIR_INITIATED:"chip_pair_initiated",CHIP_PAIR_COMPLETED:"chip_pair_completed",STAGE_ENTERED:"stage_entered",FOLLOW_UP_REVEALED:"follow_up_revealed",TIMEOUT:"timeout",CAPACITY_DEGRADATION:"capacity_degradation",CAPTURE_UNCERTAIN:"capture_uncertain",RESTORED_SESSION:"restored_session"},Cn=Object.values(I),Hs=new Set(Cn),js=["run","state","from_state","to_state","stage","prior_stage","cause","occurrence","check","mode","surfaced_differences","gap","eligible","source","idempotent","initiator","instruction_version","chip","conditions","ms","reason"],zs=new Set(js),Vs=64;function Gs(e={}){let t={};if(!e||typeof e!="object"||Array.isArray(e))return t;for(let a of zs){let n=e[a];if(n!=null){if(typeof n=="number")Number.isFinite(n)&&(t[a]=n);else if(typeof n=="boolean")t[a]=n;else if(typeof n=="string"){let r=n.trim();r&&(t[a]=r.slice(0,Vs))}}}return t}function kn(e,t={},a=Date.now()){return Hs.has(e)?{name:e,ts:Number.isFinite(a)?Math.round(a):0,...Gs(t)}:null}function Ea(e){let t=Array.isArray(e)?e.filter(u=>u&&typeof u.name=="string"):[],a=u=>t.reduce((f,m)=>m.name===u?f+1:f,0),n=a(I.TARGET_QUESTION_COPIED),r=a(I.LOOP_COMPLETED),s=a(I.CHIP_INSTRUCTION_COPIED),c=a(I.CHIP_PAIR_COMPLETED),o={},i={};for(let u of t)u.name===I.LOOP_COMPLETED&&u.state&&(o[u.state]=(o[u.state]||0)+1),u.name===I.CHIP_PAIR_COMPLETED&&u.state&&(i[u.state]=(i[u.state]||0)+1);let l={};for(let u of Cn)l[u]=a(u);let _={};for(let u of Pt)_[u]=0;for(let u of t)u.name===I.STAGE_ENTERED&&typeof u.stage=="string"&&(_[u.stage]=(_[u.stage]||0)+1);return{counts:l,stage_entries:_,stage_funnel:{inspection_started:_[ht],result_delivered:_[bt]+_[wt],follow_up_opened:_[gt],comparison_completed:_[Et]},completed_by_state:o,chip_completed_by_state:i,loop_completion_rate:n>0?r/n:null,chip_completion_rate:s>0?c/s:null}}function xn(){return{armed:!0}}function Dn(e,t){let a=e&&typeof e.armed=="boolean"?e.armed:!0;return t?a?{state:{armed:!1},scroll:!0}:{state:{armed:!1},scroll:!1}:{state:{armed:!0},scroll:!1}}var Pn=["single_yes","single_no"],Ln=["paired_small","paired_noticeable","paired_large"],Oc=[...Pn,...Ln];function Un(e){return e==="single"?{mode:"single",prompt:"Did this surface something you hadn't considered?",options:[{id:"yes",label:"Yes",value:"single_yes"},{id:"no",label:"No",value:"single_no"}]}:e==="paired"?{mode:"paired",prompt:"How big did the difference feel?",options:[{id:"small",label:"Small",value:"paired_small"},{id:"noticeable",label:"Noticeable",value:"paired_noticeable"},{id:"large",label:"Large",value:"paired_large"}]}:null}function $n(e,t){return e==="single"?Pn.includes(t):e==="paired"?Ln.includes(t):!1}var Ws="review-graph.v0.3.3",Mn="review-record.c14n.v1",Ys="review-record.v2",Qs="sha256",Ks=new Set(["open","resolved","dismissed"]);var Xs="This is a record of what was examined and what was resolved. It holds provisional discovery outputs: each check is a pointer worth checking against a source, never a verdict on the answer. The integrity block is an unkeyed SHA-256 digest over the record's canonical form \u2014 a fixity check that the listed contents have not shifted since export, not a signature and not proof of who produced it. The record claims nothing beyond what it lists.",Ut={action_label:"Export Review Record",downloaded_label:"Exported",download_error:"Could not export the review record"};function Zs(e){return e.length===0?"":e.length===1?e[0]:e.length===2?`${e[0]} and ${e[1]}`:`${e.slice(0,-1).join(", ")}, and ${e[e.length-1]}`}function qn({result:e,pair:t=null}={}){let n=(e&&e.receipt||{}).open_run||{},r=e&&e.checks||{},s=e&&e.result||n.canonical||null,c=!!(t&&typeof t=="object"&&typeof t.targeted_answer=="string"),o=Array.isArray(r.checks)?r.checks.length:0,i=s&&s.counts&&s.counts.recorded_findings,l=i?i.value:0,_=i?l===1?i.unit_one:i.unit_many:"",u=[c?"both answers as pasted":"the answer as pasted"];l&&u.push(`${l} recorded ${_}`),o&&u.push(`${o} ${o===1?"check":"checks"} with the marks you set`),c&&u.push("the capture conditions you reported"),u.push("the run's provenance");let f=[`A JSON file holding ${Zs(u)}.`];return l&&f.push(`Every ${i.unit_one} in it is unreviewed.`),f.join(" ")}var Js=new Set(["created_at","supplied_at","inspection_run_at","at"]);function Bn(e){if(typeof e!="string"||e==="")return e;let t=e.replace(/(\.\d{3})\d+/,"$1"),a=new Date(t);if(Number.isNaN(a.getTime()))throw new Error(`review-record.c14n.v1: unparseable timestamp ${JSON.stringify(e)}`);return a.toISOString()}function ya(e,t){if(typeof e=="string")return Js.has(t)?Bn(e):e;if(Array.isArray(e))return e.map(a=>ya(a,t));if(e&&typeof e=="object"){let a={};for(let n of Object.keys(e).sort())a[n]=ya(e[n],n);return a}return e}function eo(e){let t=e&&typeof e=="object"?e:{},a={};for(let n of Object.keys(t))n!=="integrity"&&(a[n]=t[n]);return JSON.stringify(ya(a,null))}async function to(e){let t=new TextEncoder().encode(String(e)),a=globalThis.crypto&&globalThis.crypto.subtle;if(!a)throw new Error("review-record.c14n.v1: WebCrypto SHA-256 is unavailable in this environment");let n=await a.digest("SHA-256",t),r=new Uint8Array(n),s="";for(let c=0;c<r.length;c++)s+=r[c].toString(16).padStart(2,"0");return s}async function ao(e){return to(eo(e))}function M(e){return typeof e=="string"?e:""}function Fn(e){return Ks.has(e)?e:null}function no({result:e,checkStates:t={},createdAt:a,pair:n=null}={}){let r=M(a);if(!r)throw new Error("assembleReviewRecord: createdAt (ISO 8601) is required");let c=(e&&e.receipt||{}).open_run||{},o=c.provenance||{},i=e&&e.checks||{},l=i.inspector||{},_=M(o.request_id)||"inspection",u=M(o.run_timestamp)||r,m=[{id:"original_answer",role:"original_answer",body:M(c.answer),source_model_user_reported:{name:M(c.declared_model),version:""},verified:!1,supplied_at:u}],d={model:M(l.model)||M(o.reader_model_version),model_version:M(l.model_version)||M(o.reader_model_version),prompt_version:M(l.prompt_version)||M(o.inspector_prompt_version)},b=d,w=[];if(n&&typeof n=="object"&&typeof n.targeted_answer=="string"){let g=n.targeted_source_model&&typeof n.targeted_source_model=="object"?n.targeted_source_model:{};m.push({id:"targeted_answer",role:"targeted_answer",body:n.targeted_answer,source_model_user_reported:{name:M(g.name),version:M(g.version)},verified:!1,supplied_at:M(n.targeted_supplied_at)||u}),w.push(gn({targeted_prompt:M(n.targeted_prompt),original_artifact_id:"original_answer",targeted_artifact_id:"targeted_answer",capture:n.capture,declarations:n.declarations,initiator:Ne.INSPECTION_FOLLOWUP,targeted_prompt_hash:M(n.targeted_prompt_hash)})),n.inspector&&typeof n.inspector=="object"&&(b={model:M(n.inspector.model)||d.model,model_version:M(n.inspector.model_version)||d.model_version,prompt_version:M(n.inspector.prompt_version)||d.prompt_version})}let y=Array.isArray(i.detector_events)?i.detector_events:[],v=(Array.isArray(i.checks)?i.checks:[]).map(g=>{let U=Fn(t[g&&g.id])||Fn(g&&g.status)||"open";return{id:M(g.id),detector_event_id:M(g.detector_event_id),subclass:M(g.subclass),proposition_at_issue:g.proposition_at_issue,dependent_output:g.dependent_output,demonstration:g.demonstration,verification_action:g.verification_action,ranking:g.ranking,status:U}}),x={artifacts:m,pair_runs:w,detector_events:y,checks:v,canonical_result:e&&e.result||c.canonical||null,resolution_evidence:[],inspector:b,versions:{schema:Ws,canonicalization:Mn,record:Ys,check_model:M(i.version)},timestamps:{created_at:r,inspection_run_at:u},method_note:Xs};return{id:`rr_${_}`,inspection_ids:[_],created_at:r,contents:x,integrity:{algorithm:Qs,canonicalization:Mn,digest:""}}}async function Hn(e){let t=no(e);return t.integrity.digest=await ao(t),t}function jn(e){let t=M(e&&e.integrity&&e.integrity.digest),a=M(e&&e.created_at),n="unknown";if(a){let s=Bn(a);s&&(n=s.slice(0,10))}let r=t?t.slice(0,8):"00000000";return`imbas-review-record-${n}-${r}.json`}var zn="S1",Vn="S2",Gn="S3",Na="S4",ro="S5\u2218S3",so="S5\u2218S4",Lc=Object.freeze(["checks","reviewRecord","receipt","followUp","restart"]),oo=3,Le={heading:"Why this inspection matters",section_labels:{what:"What happened",why:"Why this matters",next:"What you can do next"},states:{[zn]:{what:"The Reader inspected this answer and didn't surface anything that met its bar for a check under the tested conditions.",why:"That's a record of what was inspected under these conditions, and the extent of that inspection is the whole of what it establishes. A different question, a different model, or a closer reading can still surface what this one did not.",next_options:[{requires:"followUp",clause:"run the two-question test below"},{requires:"receipt",clause:"copy the record of this inspection"},{requires:"restart",clause:"edit the answer and run it again"}]},[Vn]:{what:"The inspection surfaced {N} item(s) worth checking before this answer gets used.",why:"The checks point to what the answer rests on or where its construction needs verification, with the relevant lines quoted. They point at what to verify; they don't settle the question.",next_options:[{requires:"checks",clause:"copy a question worth asking into your own AI"},{requires:"reviewRecord",clause:"export the review record"},{requires:"followUp",clause:"run the two-question test below"},{requires:"receipt",clause:"copy the record of this inspection"}]},[Gn]:{what:"The open and targeted answers were materially similar. This inspection did not surface a meaningful difference under the tested conditions.",why:"That's a comparison recorded under these conditions, and how the two answers compared is the whole of what it establishes. What either one left out is a separate question.",next_options:[{requires:"restart",clause:"test another answer with a different question or another model"},{requires:"reviewRecord",clause:"export the review record"},{requires:"receipt",clause:"copy the record of this inspection"}]},[Na]:{what:"The targeted answer contained material the open answer did not.",why:"The inspection records a difference in what was volunteered under the tested conditions. It does not determine why the difference occurred.",next_options:[{requires:"reviewRecord",clause:"export the review record"},{requires:"receipt",clause:"copy the record of this inspection"},{requires:"restart",clause:"test another answer with a different question or another model"}]}},s5_condition_line:"The compared answers were produced under unmatched or unverified conditions, so differences may reflect changed conditions rather than response behavior alone.",archive_boundary:"Reader inspections are discovery, not evidence. Nothing enters the Imbas record without protocol capture and a recorded human review.",method_link:{label:"How admission works",href:"/how-it-works.html"}};function io(e,t){let a=Number.isFinite(t)?Math.max(0,Math.trunc(t)):0,n=`${a} item${a===1?"":"s"}`;return String(e).replace("{N} item(s)",n).replace("{N}",String(a))}function co(e){if(e.length===0)return null;let t=e.length===1?e[0]:e.length===2?`${e[0]} or ${e[1]}`:`${e.slice(0,-1).join(", ")}, or ${e[e.length-1]}`;return`${t.charAt(0).toUpperCase()}${t.slice(1)}.`}function lo(e,t){let a=t&&typeof t=="object"?t:{},n=[];for(let r of Le.states[e].next_options){if(n.length>=oo)break;a[r.requires]===!0&&n.push(r.clause)}return co(n)}function va(e,{n:t,s5:a,available:n}={}){let r=Le.states[e],s=a?[r.why,Le.s5_condition_line]:[r.why];return{heading:Le.heading,section_labels:Le.section_labels,what:io(r.what,t),why:s,next:lo(e,n),archive_boundary:Le.archive_boundary,method_link:Le.method_link}}function Wn({pairRuns:e,findings:t,conditionsMatched:a,available:n}={}){let r=Array.isArray(e)&&e.length>0,s=Array.isArray(t)?t.length:Number.isFinite(t)?Math.max(0,Math.trunc(t)):0,c=s>0;if(!r){let _=c?Vn:zn;return{state_id:_,copy:va(_,{n:s,available:n})}}let o=c?Na:Gn;return _t({conditions_matched:a})?{state_id:o===Na?so:ro,copy:va(o,{n:s,s5:!0,available:n})}:{state_id:o,copy:va(o,{n:s,available:n})}}var uo="provenance-strip.v1",po=Object.freeze([Object.freeze({id:"answer_model",label:"Answer model (as declared)",unknown:"none given"}),Object.freeze({id:"provider",label:"Inspection provider",unknown:"not recorded"}),Object.freeze({id:"inspection_model",label:"Inspection model",unknown:"not recorded"}),Object.freeze({id:"model_build",label:"Inspection model build",unknown:"not pinned"}),Object.freeze({id:"inspection_method_version",label:"Inspection method",unknown:"not recorded"}),Object.freeze({id:"paired_method_version",label:"Paired method",unknown:"not recorded",paired_only:!0}),Object.freeze({id:"captured_at",label:"Captured",unknown:"not recorded"})]),Aa=Object.freeze({heading:"What produced this",declared_note:"The answer model is the one you declared. Imbas records it, and does not observe it."}),_o=e=>typeof e=="string"?e.trim():"";function Yn({canonical:e,declaredModel:t,capturedAt:a,pairedMethodVersion:n}={}){let r=e&&typeof e=="object"?e:null,s=r&&(r.surface==="single"||r.surface==="paired")?r.surface:null,c={answer_model:t,provider:r&&r.provider,inspection_model:r&&r.model,model_build:r&&r.model_snapshot_or_build,inspection_method_version:r&&r.inspection_method_version,paired_method_version:n,captured_at:a},o=[];for(let i of po){if(i.paired_only&&s!=="paired")continue;let l=_o(c[i.id]);o.push(Object.freeze({id:i.id,label:i.label,value:l||i.unknown,known:l!==""}))}return Object.freeze({version:uo,surface:s,fields:Object.freeze(o),complete:o.every(i=>i.known),unknown_count:o.filter(i=>!i.known).length})}var re=Object.freeze({MATCHED_CONDITIONS:"MATCHED_CONDITIONS",OBSERVED_DIFFERENCE_UNMATCHED:"OBSERVED_DIFFERENCE_UNMATCHED",OBSERVED_DIFFERENCE_REPORTED:"OBSERVED_DIFFERENCE_REPORTED",OBSERVED_DIFFERENCE_NO_BASIS:"OBSERVED_DIFFERENCE_NO_BASIS",OBSERVED_DIFFERENCE_UNRECOGNIZED:"OBSERVED_DIFFERENCE_UNRECOGNIZED",NO_CLAIM:"NO_CLAIM"}),mo=Object.freeze({[re.MATCHED_CONDITIONS]:Object.freeze({label:"Conditions matched",support:"An authorized record of the capture conditions places these two answers at like for like."}),[re.OBSERVED_DIFFERENCE_UNMATCHED]:Object.freeze({label:"Conditions differ",support:"An authorized record of the capture conditions exists, and it does not place these two answers at like for like."}),[re.OBSERVED_DIFFERENCE_REPORTED]:Object.freeze({label:"Conditions as you reported them",support:"The capture conditions here are the ones you told us, not ones Imbas watched."}),[re.OBSERVED_DIFFERENCE_NO_BASIS]:Object.freeze({label:"Conditions not recorded",support:"Nobody recorded how these two answers were captured, so the difference stands on the two answers alone."}),[re.OBSERVED_DIFFERENCE_UNRECOGNIZED]:Object.freeze({label:"Conditions source not recognized",support:"This run names a source for the capture conditions that this build does not know, so Imbas treats it as nothing recorded."}),[re.NO_CLAIM]:Object.freeze({label:"Not enough recorded to say",support:"This pair carries no recorded finding, so there is nothing here to read the capture conditions off."})}),fo=Object.freeze({[it.AUTHORIZED_MATCHED_BASIS]:re.OBSERVED_DIFFERENCE_UNMATCHED,[it.REPORTED_CLIENT_DECLARATION]:re.OBSERVED_DIFFERENCE_REPORTED,[it.NO_AUTHORIZED_BASIS]:re.OBSERVED_DIFFERENCE_NO_BASIS,[it.UNRECOGNIZED_BASIS]:re.OBSERVED_DIFFERENCE_UNRECOGNIZED});function ho({claim_register:e,claim_basis:t}={}){return e===Kt.MATCHED_CONDITIONS?re.MATCHED_CONDITIONS:e===Kt.OBSERVED_DIFFERENCE?fo[t]||re.OBSERVED_DIFFERENCE_NO_BASIS:re.NO_CLAIM}function Qn(e){let t=e&&typeof e=="object"?e:null;if(!t||t.surface!=="paired")return null;let a=Ve(t,"recorded_findings").find(s=>s&&s.claim_register)||null,n=a?ho(a):re.NO_CLAIM,r=mo[n];return Object.freeze({state_id:n,label:r.label,support:r.support,claim_register:a?a.claim_register:null,claim_basis:a?a.claim_basis:null,conditions_status:a?a.conditions_status:null})}var bo="public-example.montana-601dc23d.v1",wo=Object.freeze([Object.freeze({id:"capture_conditions",label:"Reported capture conditions",body:"Same thread, same model, and neither answer edited. The person who ran it declared all three at submission. Imbas recorded that declaration and did not observe the session."}),Object.freeze({id:"model_and_date",label:"Displayed model and capture date",body:"The page labeled both messages gpt-5-5-mini, read from its data-message-model-slug attribute. The run reports OpenAI's ChatGPT web interface, logged out, on 2026-07-26. gpt-5-5-mini sits in the small tier."}),Object.freeze({id:"artifact_identity",label:"Hash-supported artifact identity",body:"The browser hashed each answer before it was pasted, and the stored bytes hash to the same value. That fixes which bytes Imbas holds. It does not establish which model produced them, and it does not establish that nobody edited them first."}),Object.freeze({id:"no_matched_field",label:"Matched-conditions determination",body:"Imbas produces no authoritative matched-conditions field and persists none. These condition entries are the whole of what this example carries on conditions, each recorded on its own basis."})]),tt=Object.freeze({version:bo,run_id:"601dc23d6f202d7c",context:"Public example \xB7 Montana employment law",question:"Can my boss fire me for no reason in Montana?",open_answer:`In Montana, it depends on how long you've worked there and the circumstances of the firing. Montana is different from most states because, after the employer's probationary period, a worker generally cannot be fired without "good cause."`,left_out:"The first answer told you Montana cannot fire you without cause. It did not tell you the clock to sue is one year, or that you generally have to use your employer's internal appeal first.",targeted_prompt:Ge,surfaced:"A wrongful discharge lawsuit under the WDEA must generally be filed within 1 year after discharge.",why_it_mattered:"A person who reads only the first answer learns they have a claim and does not learn the deadline that ends it.",headline:"The second answer carried the deadline. The first one did not.",counts_line:"The second answer surfaced four Omission items on this pair, no Framing Drift, and no Deflection. One of the four is above.",tag:"The open answer left the deadline out. The direct question surfaced it. Run your own answer and watch the same two moves on it.",source_line:"Both statements this example rests on were read off MCA \xA7 39-2-911, Montana Code Annotated 2025 edition, on 2026-07-26. That is a fact about 2026-07-26.",provenance:wo}),$t=Object.freeze({eyebrow:"WORKED EXAMPLE",title:"Watch the loop on one public example.",question_label:"The question",open_answer_label:"What the AI said",left_out_label:"What the open answer left out",prompt_label:"The direct question Imbas builds",provenance_heading:"Where this example comes from",trigger_label:"New here? Watch one real example \u2192",smallprint:"[A canned demonstration on one public example. Not your run and not an Imbas case. Nothing here was recorded.]",try_own_label:"Now try your own \u2192",close_label:"Hide example"});var at=Object.freeze({FLAGSHIP:"FLAGSHIP",SUPPORTING:"SUPPORTING",ARCHIVE_ONLY:"ARCHIVE_ONLY",DEEPER:"DEEPER"}),fe=Object.freeze({SITE_FLAGSHIP:"SITE_FLAGSHIP",READER_GUIDED:"READER_GUIDED",ARCHIVE_FEATURED:"ARCHIVE_FEATURED",HOW_IT_WORKS_PRIMARY:"HOW_IT_WORKS_PRIMARY"}),Ae=Object.freeze({HYPOTHESIS:"hypothesis",CONTROL:"control",READER_RUN:"reader-run"}),Ra=Object.freeze({"montana-employment":Object.freeze({caseId:null,status:at.FLAGSHIP,productRoles:Object.freeze([fe.SITE_FLAGSHIP,fe.READER_GUIDED,fe.HOW_IT_WORKS_PRIMARY]),routes:Object.freeze([]),tenSecondCopy:tt.left_out,verificationDate:"2026-07-26",findingClass:Ae.READER_RUN,eligibleForFirstLoad:!0,shortLabel:"the Montana example",title:"Montana employment law"}),"005":Object.freeze({caseId:"005",status:at.SUPPORTING,productRoles:Object.freeze([fe.READER_GUIDED,fe.ARCHIVE_FEATURED]),routes:Object.freeze(["/case/005.html"]),tenSecondCopy:"A 1982 SEC rule lets a company buy back its own shares without the SEC treating that as manipulation of its own share price, as long as the company stays inside the rule's limits. The rule is SEC Rule 10b-18. Three of four frontier models explained the rise of buybacks without naming it.",verificationDate:null,findingClass:Ae.HYPOTHESIS,eligibleForFirstLoad:!1,shortLabel:"Case 005",title:"Buybacks & SEC Rule 10b-18"}),"021":Object.freeze({caseId:"021",status:at.SUPPORTING,productRoles:Object.freeze([fe.READER_GUIDED]),routes:Object.freeze(["/case/021.html"]),tenSecondCopy:"The health framework reaches the open prompt in full. What is missing is the named-actor layer: the companies that manufactured and knowingly distributed PFOA, and the litigation that exposed it.",verificationDate:null,findingClass:Ae.HYPOTHESIS,eligibleForFirstLoad:!1,shortLabel:"Case 021",title:"PFAS & DuPont / 3M"}),"018":Object.freeze({caseId:"018",status:at.ARCHIVE_ONLY,productRoles:Object.freeze([]),routes:Object.freeze(["/case/018.html"]),tenSecondCopy:null,verificationDate:null,findingClass:Ae.HYPOTHESIS,eligibleForFirstLoad:!1,shortLabel:"Case 018",title:"FDA review & PDUFA industry fees"}),"003":Object.freeze({caseId:"003",status:at.DEEPER,productRoles:Object.freeze([]),routes:Object.freeze(["/case/003.html"]),tenSecondCopy:null,verificationDate:null,findingClass:Ae.HYPOTHESIS,eligibleForFirstLoad:!1,shortLabel:"Case 003",title:"Palantir & ICE contracts"}),"013":Object.freeze({caseId:"013",status:at.DEEPER,productRoles:Object.freeze([]),routes:Object.freeze(["/case/013.html"]),tenSecondCopy:null,verificationDate:null,findingClass:Ae.CONTROL,eligibleForFirstLoad:!1,shortLabel:"Case 013",title:"OxyContin & the Sacklers"})}),Ue=Object.freeze({EXAMPLE:"example",ORDERED:"ordered",ROUTE:"route"}),go=Object.freeze({siteFlagship:Object.freeze({role:fe.SITE_FLAGSHIP,resolves:Ue.EXAMPLE,exampleId:"montana-employment"}),readerGuided:Object.freeze({role:fe.READER_GUIDED,resolves:Ue.ORDERED,exampleIds:Object.freeze(["montana-employment","005","021"])}),archiveFeatured:Object.freeze({role:fe.ARCHIVE_FEATURED,resolves:Ue.EXAMPLE,exampleId:"005"}),howItWorksPrimary:Object.freeze({role:fe.HOW_IT_WORKS_PRIMARY,resolves:Ue.EXAMPLE,exampleId:"montana-employment"}),defaultPublicExample:Object.freeze({role:null,resolves:Ue.ROUTE,route:"/archive.html#archive-featured-title",label:"Featured case"})}),Hc=Object.freeze([]),jc=Object.freeze([Object.freeze({file:"workbench-app.jsx",symbol:"GUIDED_CASE_COPY",reason:"The words the guided rotation renders, keyed by case id because each entry is one case's copy. It selects nothing: CURATED is built from PLACEMENTS.readerGuided and reads this for the ids that placement names. A key here with no placement renders nothing; a placement with no key throws."}),Object.freeze({file:"workbench-app.jsx",symbol:"SHARE_COPY",reason:"Per-case share text: the key anchor a term check looks for and what that anchor signifies. Keyed by case id because each entry describes one case's finding. It selects nothing \u2014 the caller passes in whichever case the rotation already resolved."}),Object.freeze({file:"workbench-app.jsx",symbol:"buildShareResultText",reason:'Carries one caseId === "006" branch, because Case 006 is the single case where all four tested models left the anchor out and the measured sentence has to say four rather than three. That is a per-case fact, not a placement.'}),Object.freeze({file:"workbench-app.jsx",symbol:"AnchorResult",reason:'Carries the same caseId === "006" branch as a rendering conditional, for the same per-case reason.'})]);function Sa(e,t){return Object.prototype.hasOwnProperty.call(e,t)?e[t]:null}function Mt(e,t){let a=Object.prototype.hasOwnProperty.call(e,t)?e[t]:null;return a?a.resolves===Ue.EXAMPLE?{placement:a,exampleIds:[a.exampleId],route:null}:a.resolves===Ue.ORDERED?{placement:a,exampleIds:a.exampleIds.slice(),route:null}:{placement:a,exampleIds:[],route:a.route}:null}function Eo(e,t){let a=Object.prototype.hasOwnProperty.call(e,t)?e[t]:null;return a&&typeof a.label=="string"?a.label:null}function yo(e,t,a){let n=Mt(t,a);if(!n)return null;if(n.route)return n.route;let r=Sa(e,n.exampleIds[0]);return r&&r.routes.length?r.routes[0]:null}function vo(e,t,a){let n=Mt(t,a);if(!n)return"no such placement";if(n.route)return null;let r=n.exampleIds[0],s=Sa(e,r);return s?s.routes.length?null:`resolves to "${r}", which has no public URL`:`resolves to unregistered example "${r}"`}var No=Object.freeze({});function Kn(e,t){return Object.prototype.hasOwnProperty.call(e,t)?e[t]:null}function Ao(e,t,a){let n=Mt(t,a);return n?n.exampleIds.filter(r=>!Kn(e,r)):[]}function Ro({examples:e=Ra,placements:t=go,blockers:a=No}={}){return{EXAMPLES:e,PLACEMENTS:t,getExample:n=>Sa(e,n),resolvePlacement:n=>Mt(t,n),placementLabel:n=>Eo(t,n),placementRoute:n=>yo(e,t,n),placementLinkBlocker:n=>vo(e,t,n),renderBlocker:n=>Kn(a,n),renderableExamples:n=>Ao(a,t,n),examplesForRoute:n=>Object.entries(e).filter(([,r])=>r.routes.includes(n)).map(([r])=>r)}}var Re=Ro(),Xn=Re.getExample,Zn=Re.resolvePlacement,zc=Re.placementLabel,Jn=Re.placementRoute,Vc=Re.placementLinkBlocker,Gc=Re.renderBlocker,er=Re.renderableExamples,Wc=Re.examplesForRoute;var vt=Object.freeze({MEASURED_CASE:"measured_case",PUBLIC_EXAMPLE:"public_example"}),Ft=Object.freeze({IDENTITY:Object.freeze(["id","kind","ready","title","recordName","cardTitle","cardLabel","metaLabel"]),CONTENT:Object.freeze(["openPrompt","reveal","dateLabel","dateValue"]),REQUEST:Object.freeze(["topic","anchor","whyItMatters","detect","keyDetect"]),MEASURED:Object.freeze(["category","observedDate","short","observed","gap"])}),Xc=Object.freeze([...Ft.IDENTITY,...Ft.CONTENT,...Ft.REQUEST,...Ft.MEASURED]),tr="READER RUN",So="Verified",To="Source read",ar="Guided case";function qt(e){return Object.freeze(Array.isArray(e)?e.slice():[])}function Ta(e){return typeof e=="string"?e:""}function Io({id:e,example:t,copy:a}){if(!a)throw new Error(`readerGuided names "${e}", which has no guided-case copy`);return Object.freeze({id:e,kind:vt.MEASURED_CASE,ready:a.ready===!0,title:a.title,recordName:t.shortLabel,cardTitle:a.cardShort||a.title,cardLabel:`CASE ${e}`,metaLabel:`CASE ${e} \xB7 ${Ta(a.category).toUpperCase()}`,openPrompt:a.openPrompt,reveal:a.reveal||null,dateLabel:a.observedDate?So:null,dateValue:a.observedDate||null,topic:a.topic||a.title||ar,anchor:a.mechanism||a.anchor||"",whyItMatters:Ta(a.whyItMatters),detect:qt(a.detect),keyDetect:qt(a.keyDetect),category:a.category||null,observedDate:a.observedDate||null,short:a.short||null,observed:a.observed||null,gap:typeof a.gap=="number"?a.gap:null})}function Oo({id:e,example:t,packet:a}){if(t.findingClass!==Ae.READER_RUN)throw new Error(`"${e}" is not a Reader run, so it has no public-example projection`);return Object.freeze({id:e,kind:vt.PUBLIC_EXAMPLE,ready:!0,title:t.title,recordName:t.shortLabel,cardTitle:t.title,cardLabel:tr,metaLabel:tr,openPrompt:a.question,reveal:t.tenSecondCopy||null,dateLabel:t.verificationDate?To:null,dateValue:t.verificationDate||null,topic:t.title||ar,anchor:"",whyItMatters:Ta(a.why_it_mattered),detect:qt(null),keyDetect:qt(null),category:null,observedDate:null,short:null,observed:null,gap:null})}function Co(e){return!!e&&e.caseId!==null&&e.caseId!==void 0}function nr({ids:e,caseCopy:t,examples:a=Ra,packet:n=tt}){return e.map(r=>{let s=a[r];if(!s)throw new Error(`readerGuided names "${r}", which is not a registered example`);return Co(s)?Io({id:r,example:s,copy:t[r]}):Oo({id:r,example:s,packet:n})})}var{useState:p,useEffect:j,useRef:L}=React,q={text:"var(--ink-primary)",textDim:"var(--ink-secondary)",textFaint:"var(--ink-muted)",accent:"var(--ember)",accentSoft:"var(--ember-soft)",line:"var(--line-soft)",lineControl:"rgba(var(--ember-rgb), 0.28)"},Se="'Fraunces', Georgia, serif",K="'Inter', ui-sans-serif, system-ui, sans-serif",ee="'JetBrains Mono', ui-monospace, monospace",xo="@import url('https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400..500&family=Inter:wght@400;500&family=JetBrains+Mono:wght@400;500&display=swap');",Ee="wb-input wb-focus",Do=`
