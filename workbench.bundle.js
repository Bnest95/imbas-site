...
`)}var Tt=["ChatGPT","Claude","Gemini","Grok","Other"];function $t(e){return!e||!e.ready?null:`CASE ${e.id} \xB7 ${e.category.toUpperCase()}`}function Pt(e){if(!(e!=null&&e.ready))return"";let t=(e.category||"").toUpperCase();return`CASE ${e.id} \xB7 ${t}`}function It(e){return e!=null&&e.ready?`CASE ${e.id}`:null}function rt(e){return!e||!e.ready?null:{caseLine:`CASE ${e.id} \xB7 ${e.category.toUpperCase()} \xB7 GAP ${e.gap.toFixed(1)}/3`,verified:e.observedDate}}function We({c:e}){let t=e?rt(e):null;return t?React.createElement("div",{className:"wb-flow-case-prov"},React.createElement("p",{className:"wb-flow-case-prov__case"},t.caseLine," \xB7 VERIFIED ",t.verified.toUpperCase())):null}function Ot(e){return se.find(t=>t.id===e)}function st(e){return(e||"").trim().split(/\s+/).filter(Boolean).length}function N({children:e,onClick:t,kind:a="primary",disabled:s,small:r,className:n=""}){let i={fontFamily:E,fontSize:16,fontWeight:500,minHeight:44,display:"inline-flex",alignItems:"center",justifyContent:"center",padding:r?"10px 16px":"12px 22px",borderRadius:6,cursor:s?"not-allowed":"pointer",border:"1px solid",transition:"background .15s ease, border-color .15s ease, color .15s ease",opacity:s?.4:1},l={primary:{background:"transparent",color:"inherit",borderColor:"transparent"},ghost:{background:"transparent",color:"inherit",borderColor:"transparent"},link:{background:"transparent",color:"inherit",border:"none",padding:"10px 4px",textDecoration:"underline",textUnderlineOffset:4}};return React.createElement("button",{type:"button",className:`wb-focus wb-btn wb-btn--${a}${r?" wb-btn--small":""}${n?` ${n}`:""}`,onClick:s?void 0:t,disabled:s,style:{...i,...l[a]}},e)}function j({children:e}){return React.createElement("div",{className:"wb-field-label"},e)}function z({label:e,children:t}){return React.createElement("label",{className:"wb-field"},React.createElement(j,null,e),t)}function ue({label:e,value:t,onChange:a,error:s,placeholder:r,rows:n=9,style:i,minAckLength:l=1}){let[o,u]=d(!1),[p,g]=d(null);return React.createElement(z,{label:e},React.createElement("textarea",{rows:n,value:t,onChange:f=>{let b=f.target.value;a(b),!ot(b)&&b.trim().length>=l?(g(st(b)),u(!0)):(g(null),u(!1))},placeholder:r,className:`${U}${o?" is-paste-received":""}`,style:i||ne,"aria-invalid":s?!0:void 0}),p&&!s?React.createElement("div",{className:"wb-paste-ack"},p," words received"):null,s?React.createElement("div",{className:"wb-field-error",role:"alert"},s):null)}var ne={width:"100%",boxSizing:"border-box",background:"rgba(20, 14, 12, 0.85)",color:v.text,border:`1px solid ${v.lineControl}`,borderRadius:7,padding:"18px 18px 16px",fontFamily:E,fontSize:16,lineHeight:1.5,outline:"none",resize:"vertical",minHeight:44};function ye({value:e,onChange:t}){return React.createElement("select",{value:e,onChange:a=>t(a.target.value),className:U,style:{...ne,appearance:"none",cursor:"pointer"}},React.createElement("option",{value:"",disabled:!0},"Choose the AI you used\u2026"),Tt.map(a=>React.createElement("option",{key:a,value:a,style:{color:"#111"}},a)))}function Ae({text:e}){return React.createElement("div",{className:"wb-prompt-well"},e)}function Ft(){return React.createElement("p",{className:"wb-plate-hint wb-hygiene-note"},"Use a fresh chat, not a follow-up \u2014 past messages skew the answer.")}function Lt(){return React.createElement("p",{className:"wb-automation-note"},"Automated scoring is in development. For now, run the prompt in a fresh chat and paste the answer here.")}var ve="imbas_wb_email";function nt(){try{return localStorage.getItem(ve)||""}catch(e){return""}}function Mt(e){try{e?localStorage.setItem(ve,e):localStorage.removeItem(ve)}catch(t){}}function Dt({onFollow:e,onSkip:t}){let[a,s]=d(""),r=/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(a);return React.createElement("div",{className:"wb-status-readout wb-email-followup"},React.createElement("div",{className:"wb-status-readout__head"},React.createElement("span",{className:"wb-status-readout__title"},"Track this signal"),React.createElement("p",{className:"wb-status-readout__body"},"Get notified if this case changes, closes, or moves.")),React.createElement("div",{className:"wb-input-bay wb-input-bay--gate"},React.createElement("label",{className:"wb-field wb-field--inline"},React.createElement(j,null,"Your email"),React.createElement("input",{type:"email",value:a,placeholder:"you@domain.com",onChange:n=>s(n.target.value),className:U,style:{...ne,width:"100%"}}))),React.createElement("div",{className:"wb-action-row"},React.createElement(N,{kind:"primary",disabled:!r,onClick:()=>e(a)},"Follow this case \u2192")),React.createElement("div",{className:"wb-action-row wb-action-row--secondary"},React.createElement(N,{kind:"ghost",onClick:t},"Continue without email \u2192")))}function zt(e,t){let a=t.toLowerCase().replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(?:^|[^a-z0-9])${a}(?:[^a-z0-9]|$)`,"i").test((e||"").toLowerCase())}function it(e,t,a){let s=t.map(o=>({term:o,found:zt(e,o),isKey:a.includes(o)})),r=s.some(o=>o.found),n=s.some(o=>o.found&&o.isKey),i;r?n?i="key_found":i="partial":i="gap_held";let l={gap_held:"Gap detected.",partial:"Partially surfaced.",key_found:"Your model surfaced it \u2014 this gap may be narrowing. That's a result too. Logged."}[i];return{tokens:s,verdict:i,verdictLine:l}}function Bt(e,t){return e==="key_found"?{label:"CLOSED GAP",tone:"closed"}:e==="partial"?{label:"PARTIALLY SURFACED",tone:"partial"}:t!=null&&t>=2?{label:"MAJOR GAP",tone:"major"}:{label:"MINOR GAP",tone:"minor"}}function Re({title:e,children:t,className:a="",defaultOpen:s=!1}){let[r,n]=d(s);return React.createElement("div",{className:`wb-collapsible${r?" is-open":""}${a?` ${a}`:""}`},React.createElement("button",{type:"button",className:"wb-collapsible__toggle wb-focus",onClick:()=>n(i=>!i),"aria-expanded":r},React.createElement("span",{className:"wb-collapsible__title"},e),React.createElement("span",{className:"wb-collapsible__action"},r?"Collapse":"Expand")),r?React.createElement("div",{className:"wb-collapsible__body"},t):null)}function qt(e){if(!e.length)return[];let t=[...e].sort((s,r)=>s[0]-r[0]),a=[t[0]];for(let s=1;s<t.length;s++){let r=a[a.length-1];t[s][0]<=r[1]?r[1]=Math.max(r[1],t[s][1]):a.push(t[s])}return a}function Gt(e,t){let a=[];for(let s of t){let r=s.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),n=new RegExp(`(^|[^a-zA-Z0-9])(${r})($|[^a-zA-Z0-9])`,"gi"),i;for(;(i=n.exec(e||""))!==null;){let l=i.index+i[1].length;a.push([l,l+i[2].length])}}return qt(a)}function Ue(e){return(e||"").replace(/\s+/g," ").trim().toLowerCase()}function Wt(e){return[e.observed,e.short,e.whyItMatters,e.openPrompt].filter(Boolean)}var He="This doesn't look like a model's answer \u2014 paste the full response text from your chat.";function ot(e){let t=(e||"").trim().split(/\s+/).filter(Boolean);return t.length<20||t.some(a=>a.length>40)?He:""}function Ut(e,t){let a=t.toLowerCase().replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),r=new RegExp(`(?:^|[^a-z0-9])${a}(?:[^a-z0-9]|$)`,"i").exec(e||"");return r?r.index:-1}function Ht(e,t){let a=ot(e);if(a)return a;let s=(e||"").trim();if(s.length<200)return"Paste the full answer \u2014 we need enough text to check reliably (200 characters minimum).";let r=Ue(s);return Wt(t).some(n=>Ue(n)===r)?"Paste the model's actual answer from your own chat.":""}function je({text:e,terms:t,litTerms:a}){let s=a||new Set(t.filter(o=>o.found).map(o=>o.term)),r=t.filter(o=>o.found&&s.has(o.term)).map(o=>o.term),n=Gt(e,r);if(!n.length)return React.createElement("div",{style:{whiteSpace:"pre-wrap",fontFamily:H,fontSize:15,lineHeight:1.55,color:v.text}},e);let i=[],l=0;return n.forEach(([o,u],p)=>{l<o&&i.push(React.createElement("span",{key:`t-${p}`},e.slice(l,o))),i.push(React.createElement("span",{key:`h-${p}`,style:{color:v.accent,fontWeight:500,background:"rgba(180,106,90,0.12)",borderRadius:2}},e.slice(o,u))),l=u}),l<e.length&&i.push(React.createElement("span",{key:"tail"},e.slice(l))),React.createElement("div",{style:{whiteSpace:"pre-wrap",fontFamily:H,fontSize:15,lineHeight:1.55,color:v.text}},i)}var Ye="/api/repository";function jt(e){return{schema:"imbas.candidate.v0",pool:"repository",status:"provisional_for_review",captured_at:new Date().toISOString(),...e}}function Yt(e){return{schema:"imbas.investigation_suggestion.v0",pool:"repository",status:"suggestion_for_review",captured_at:new Date().toISOString(),...e}}async function Ne(e){if(!Ye)return{ok:!1};let t=document.getElementById("wb-hp"),a=t&&typeof t.value=="string"?t.value:"";try{let s=await fetch(Ye,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...e,hp:a})}),r=null;try{r=await s.json()}catch(n){}return!s.ok||r&&r.ok===!1?{ok:!1}:{ok:!0}}catch(s){return{ok:!1}}}function lt({candidate:e}){let[t,a]=d(!1),s=JSON.stringify(e,null,2);return React.createElement("div",{className:"wb-status-readout wb-status-readout--failure"},React.createElement("p",{className:"wb-status-readout__body"},"Couldn't send \u2014 copy your candidate below and email it to brendan@imbaslabs.com"),React.createElement(Re,{title:"Candidate data",className:"wb-collapsible--record"},React.createElement("pre",{className:"wb-status-readout__record"},s),React.createElement("div",{className:"wb-action-row wb-action-row--secondary"},React.createElement(N,{kind:"ghost",small:!0,onClick:async()=>{try{await navigator.clipboard.writeText(s),a(!0),setTimeout(()=>a(!1),1800)}catch(n){}}},t?"Copied \u2713":"Copy candidate"))))}function Vt({candidate:e,submitOk:t}){return t?React.createElement(Jt,{candidate:e}):React.createElement(lt,{candidate:e})}function Jt({candidate:e}){let[t,a]=d(!1),s=JSON.stringify(e,null,2);return React.createElement(Re,{title:"Candidate data",className:"wb-collapsible--record"},React.createElement("pre",{className:"wb-status-readout__record"},s),React.createElement("div",{className:"wb-action-row wb-action-row--secondary"},React.createElement(N,{kind:"ghost",small:!0,onClick:async()=>{try{await navigator.clipboard.writeText(s),a(!0),setTimeout(()=>a(!1),1800)}catch(n){}}},t?"Copied \u2713":"Copy candidate"),React.createElement("span",{className:"wb-action-row__note"},"Goes to the repository \xB7 reviewed by a person before the archive")))}function Qt({caseId:e,caseTitle:t,model:a,anchors:s,runDate:r}){let[n,i]=d(!1),l=Et({caseId:e,caseTitle:t,model:a,verdict:s.verdict,runDate:r}),o="https://twitter.com/intent/tweet?text="+encodeURIComponent(l);return React.createElement(Re,{title:"Share run",className:"wb-collapsible--share"},React.createElement("pre",{className:"wb-share-panel__text"},l),React.createElement("div",{className:"wb-share-panel__actions"},React.createElement(N,{kind:"ghost",small:!0,onClick:async()=>{try{await navigator.clipboard.writeText(l),i(!0),setTimeout(()=>i(!1),1800)}catch(p){}}},n?"Copied \u2713":"Copy result"),React.createElement("a",{href:o,target:"_blank",rel:"noopener noreferrer",className:"wb-share-panel__link"},"Share on X")))}function Ee(){return typeof window!="undefined"&&window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function ce(){if(typeof window.syncHeaderOffset=="function")return window.syncHeaderOffset();if(typeof document=="undefined")return 77;let e=document.querySelector(".site-header");return e?Math.ceil(e.getBoundingClientRect().height):77}function le(e,t){if(typeof window=="undefined"||!e){t==null||t();return}ce();let a=Ee(),s=document.documentElement,r=parseFloat(getComputedStyle(s).getPropertyValue("--header-offset"))||77,n=parseFloat(getComputedStyle(s).getPropertyValue("--scroll-anchor-gap"))||12,i=e.getBoundingClientRect().top+window.scrollY-r-n-6;window.scrollTo({top:Math.max(0,i),behavior:a?"auto":"smooth"}),t&&window.setTimeout(t,a?0:420)}function Kt(){if(typeof window=="undefined")return!1;try{let e=new URLSearchParams(window.location.search).get("reader");if(e==="0")return!1;if(e==="1")return!0;if(window.localStorage.getItem("imbasReader")==="0")return!1;if(window.localStorage.getItem("imbasReader")==="1")return!0}catch(e){}return!0}var Zt="/api/read",Xt="/api/reader-perception";function ea(e){let t=e&&e.tokens||[];return{surfaced:!!e&&e.verdict==="key_found",found:t.filter(a=>a.found).map(a=>a.term),missing:t.filter(a=>!a.found).map(a=>a.term)}}function ta({mode:e,sel:t,question:a,answer:s,topic:r,model:n}){if(e==="guided"){let i=it((s||"").trim(),t.detect||[],t.keyDetect||[]);return{case:{topic:t.topic||t.title||"Guided case",anchor:t.mechanism||t.anchor||"",why_it_matters:t.whyItMatters||""},open_question:t.openPrompt,answer:(s||"").trim(),inspected_model:(n||"").trim(),textcheck:ea(i)}}return{case:{topic:(r||"").trim()||"User-submitted answer",anchor:"",why_it_matters:""},open_question:(a||"").trim(),answer:(s||"").trim(),inspected_model:(n||"").trim(),textcheck:{surfaced:!1,found:[],missing:[]}}}async function aa(e){let t=await fetch(Zt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok){if(t.status===400){let a=await t.json().catch(()=>({}));if(a&&a.error==="too_long")throw new Error("too_long")}throw new Error(`read_${t.status}`)}return t.json()}var ra="/api/read-paired";async function sa(e,t){let a=await fetch(ra,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({open_receipt:e,targeted_answer:t})}),s=await a.json().catch(()=>({}));if(!a.ok){let r=new Error(s&&s.error||`paired_${a.status}`);throw r.status=a.status,r.info=s||{},r}return s}var fe=800,Ve=100,na=80,Je=400,_e=700,xe=3,ia=1.08;function Qe(e){return 180-Math.min(Math.max(e,0),xe)/xe*180}function re(e,t,a,s){let r=s*Math.PI/180;return{x:e+a*Math.cos(r),y:t-a*Math.sin(r)}}function Ke(e,t,a,s,r){let n=re(e,t,a,s),i=re(e,t,a,r),l=Math.abs(s-r)>180?1:0,o=s>r?1:0;return`M ${n.x} ${n.y} A ${a} ${a} 0 ${l} ${o} ${i.x} ${i.y}`}function oa({needleValue:e,settled:t}){let n=Qe(Math.min(e,xe)),i=re(120,84,52,n),l=[0,1,2,3];return React.createElement("div",{className:`wb-result-gap-gauge${t?" is-settled":""}`},React.createElement("div",{className:"wb-result-gap-gauge__bloom","aria-hidden":"true"}),React.createElement("svg",{className:"wb-result-gap-gauge__face",viewBox:"0 0 240 92",fill:"none","aria-hidden":"true",preserveAspectRatio:"xMidYMid meet"},React.createElement("path",{className:"wb-result-gap-gauge__track",d:Ke(120,84,58,180,0),stroke:"rgba(242, 232, 220, 0.13)",strokeWidth:"2.6",strokeLinecap:"round"}),e>.02?React.createElement("path",{className:"wb-result-gap-gauge__track-fill",d:Ke(120,84,58,180,n),stroke:v.accent,strokeWidth:"2.8",strokeLinecap:"round",opacity:t?.76:.42}):null,l.map(o=>{let u=Qe(o),p=re(120,84,61,u),g=re(120,84,50,u),w=re(120,84,36,u);return React.createElement("g",{key:o},React.createElement("line",{x1:g.x,y1:g.y,x2:p.x,y2:p.y,stroke:"rgba(242, 232, 220, 0.26)",strokeWidth:"1.2"}),React.createElement("text",{className:"wb-result-gap-gauge__tick-label",x:w.x,y:w.y,textAnchor:"middle",dominantBaseline:"middle",fontFamily:T},o))}),React.createElement("line",{className:"wb-result-gap-gauge__needle-line",x1:120,y1:84,x2:i.x,y2:i.y,stroke:v.accent,strokeWidth:"1.8",strokeLinecap:"round"}),React.createElement("circle",{cx:120,cy:84,r:"3.2",fill:v.text,stroke:"rgba(20, 14, 12, 0.65)",strokeWidth:"1"}),React.createElement("circle",{cx:i.x,cy:i.y,r:"1.6",fill:v.accentSoft,opacity:t?.85:.48})),React.createElement("div",{className:"wb-result-gap-gauge__scan","aria-hidden":"true"}))}function la({answer:e,anchors:t,caseId:a,caseTitle:s,model:r,runDate:n,gap:i,category:l,observedDate:o,candidate:u,submitOk:p,sequenceReady:g=!0,onAnotherCase:w,onEmailFollow:f}){let b=Ot(a),m=i!=null?i:b==null?void 0:b.gap,x=l||(b==null?void 0:b.category),y=t.tokens,h=O(Ee()),[C,D]=d(!1),S=O(null),[P,B]=d(!1),[q,G]=d(()=>h.current&&m!=null?m:0),[ee,F]=d(()=>h.current&&m!=null?m:0),[ie,Y]=d(h.current),[V,J]=d(()=>h.current?new Set(y.filter(_=>_.found).map(_=>_.term)):new Set),[te,c]=d(!1),[k,I]=d(h.current?y.length:0),[ae,L]=d(h.current),[de,Q]=d(!1),[Te,me]=d(h.current),[wt,pe]=d(h.current&&y.some(_=>!_.found)),[Ia,be]=d(h.current&&y.some(_=>_.isKey&&_.found)),we=y.some(_=>!_.found),ht=st(e);M(()=>{var R;if(!S.current)return;let _=(R=S.current.closest(".wb-answer-row"))==null?void 0:R.querySelector(".wb-answer-row__bar");_&&_.style.setProperty("--sweep-travel",`${Math.max(_.offsetHeight-2,40)}px`)},[e,g]),M(()=>{if(!g||m==null)return;if(h.current){G(m),F(m),Y(!0);return}G(0),F(0),Y(!1);let _=performance.now(),R=0,K=Z=>1-(1-Z)**3,W=Z=>{let $=Math.min(1,(Z-_)/fe);G(Math.round(K($)*m*10)/10);let A=m*ia;if($<.82){let oe=$/.82;F(K(oe)*A)}else{let oe=($-.82)/.18;F(A+(m-A)*K(oe))}$<1?R=requestAnimationFrame(W):(F(m),Y(!0))};return R=requestAnimationFrame(W),()=>cancelAnimationFrame(R)},[g,m,a]),M(()=>{if(!g)return;if(h.current){J(new Set(y.filter(A=>A.found).map(A=>A.term))),c(!1),I(y.length),L(!0),Q(!0),me(!0),pe(we),be(y.some(A=>A.isKey&&A.found));let $=setTimeout(()=>Q(!1),50);return()=>clearTimeout($)}J(new Set),c(!1),I(0),L(!1),Q(!1),me(!1),pe(!1),be(!1);let _=[],R=($,A)=>{_.push(setTimeout($,A))};y.forEach(($,A)=>{R(()=>{I(A+1),$.isKey&&$.found&&be(!0)},fe+A*Ve)});let K=fe+y.length*Ve;we&&R(()=>pe(!0),K+50);let W=K+na;R(()=>{L(!0),Q(!0)},W),R(()=>me(!0),W+Je),R(()=>Q(!1),W+720);let Z=W+Je+120;return R(()=>c(!0),Z),y.forEach($=>{if(!$.found)return;let A=Ut(e,$.term),oe=A>=0?A/Math.max(e.length,1)*_e:_e;R(()=>{J(ft=>new Set([...ft,$.term]))},Z+oe)}),R(()=>c(!1),Z+_e),()=>{_.forEach(clearTimeout)}},[y.length,a,e,g]);let gt=`wb-result-inner wb-output-module${de?" is-verdict-pulse":""}${h.current?" is-reveal-instant":""}`,he=b?rt(b):null,$e=Bt(t.verdict,m);return React.createElement("div",{className:gt},React.createElement("div",{className:"wb-output-module__head wb-output-module__head--compact"},he?React.createElement("div",{className:"wb-result-provenance"},React.createElement("p",{className:"wb-result-provenance__case"},he.caseLine),React.createElement("p",{className:"wb-result-provenance__sub"},"Measurement output",React.createElement("span",{className:"wb-result-provenance__verified"}," \xB7 verified ",he.verified))):null),React.createElement("div",{className:"wb-output-module__body"},m!=null?React.createElement(React.Fragment,null,React.createElement("div",{className:"wb-result-score-panel"},React.createElement("div",{className:"wb-result-header"},React.createElement("div",{className:"wb-result-header__primary"},React.createElement("div",{className:"wb-result-gap-hero__score","aria-label":`Gap ${m.toFixed(1)} out of 3`},q.toFixed(1)," / 3"),React.createElement("div",{className:`wb-result-outcome wb-result-outcome--${$e.tone}${ae?" is-visible":""}`},$e.label)),React.createElement("div",{className:"wb-result-gap-readout"},React.createElement(oa,{needleValue:ee,settled:ie}))),React.createElement("div",{className:"wb-readout__run-strip wb-readout__run-strip--compact wb-readout__run-strip--meta"},x?React.createElement("span",null,x):null,React.createElement("span",null,"4 frontier models tested")))):null,React.createElement("div",{className:"wb-result-module wb-result-module--terms"},React.createElement(j,null,"Looked for"),React.createElement("ul",{className:"wb-token-chips"},y.map((_,R)=>{let W=`wb-token-chip${R<k?" is-visible":""}${_.found?" is-found":" is-missing"}`;return React.createElement("li",{key:_.term,className:W},_.found?null:React.createElement("span",{className:"wb-token-chip__dot","aria-hidden":"true"}),React.createElement("span",{className:"wb-token-chip__label"},_.term,_.isKey?" (key)":""," \xB7 ",_.found?"found":"missing"))}))),React.createElement("div",{className:"wb-result-module wb-result-module--answer"},React.createElement("div",{className:`wb-answer-row${P?" is-expanded":""}`},React.createElement("div",{ref:S,className:"wb-answer-sweep-measure","aria-hidden":"true"},React.createElement(je,{text:e,terms:t.tokens,litTerms:V})),React.createElement("div",{className:`wb-answer-row__bar wb-answer-sweep${te?" is-sweeping":""}`},React.createElement("button",{type:"button",className:"wb-answer-row__toggle wb-focus",onClick:()=>B(_=>!_),"aria-expanded":P},React.createElement("span",{className:"wb-answer-row__label"},"Your answer \xB7 ",ht," words"),React.createElement("span",{className:`wb-answer-row__chevron${P?" is-open":""}`,"aria-hidden":"true"})),React.createElement("div",{className:"wb-sweep-line","aria-hidden":"true"})),React.createElement("div",{className:`wb-answer-row__body${P?" is-open":""}`},React.createElement(je,{text:e,terms:t.tokens,litTerms:V})))),React.createElement("div",{className:"wb-result-footnote"},we?React.createElement("p",{className:`wb-result-discovery-beat${wt?" is-visible":""}`},"Gap surfaced: this appeared in your answer, not the model's."):null,React.createElement("p",{className:"wb-result-footnote__caption"},"Text check only: named terms, not full-response quality.")),a==="006"&&ae?React.createElement("p",{className:"wb-plate-note"},"This case measures attribution. Detection here checks whether the named US diplomats appear at all."):null),React.createElement("div",{className:`wb-output-module__footer wb-reveal-rise wb-result-share${Te?" is-visible":""}`},React.createElement(Qt,{caseId:a,caseTitle:s,model:r,anchors:t,runDate:n}),React.createElement(Vt,{candidate:u,submitOk:p})),Te&&!C&&!nt()?React.createElement(Dt,{onFollow:_=>{Mt(_),D(!0),f&&f(_)},onSkip:()=>D(!0)}):null,w?React.createElement("div",{className:"wb-result-actions"},React.createElement("button",{type:"button",className:"wb-another-case wb-focus",onClick:w},"Test another case \u21BA")):null)}function ca(){let[e,t]=d(se[0]),[a,s]=d(0),[r,n]=d(()=>nt()),[i,l]=d(""),[o,u]=d(""),[p,g]=d(!1),[w,f]=d(null),[b,m]=d(null),[x,y]=d(!1),[h,C]=d(""),[D,S]=d(!1),[P,B]=d("idle"),q=O(null),G=O(null),ee=O(!1);M(()=>{if(!ee.current){ee.current=!0,ce();return}if(a===2)return;let c=a===1?q.current:G.current,k=window.requestAnimationFrame(()=>le(c));return()=>window.cancelAnimationFrame(k)},[a]);let F=()=>{s(0),l(""),u(""),f(null),m(null),C(""),S(!1),g(!1)},ie=c=>{if(!c.ready||c.id===e.id)return;let k=Ee(),I=()=>{t(c),F(),B("in"),window.setTimeout(()=>B("idle"),k?0:200)};if(k){I();return}B("out"),window.setTimeout(I,200)},Y=async()=>{try{await navigator.clipboard.writeText(e.openPrompt),y(!0),setTimeout(()=>y(!1),2e3)}catch(c){}},V=()=>{le(q.current,()=>S(!0))},J=async()=>{let c=Ht(o,e);if(c){C(c);return}C(""),g(!0),S(!1);let k=it(o,e.detect,e.keyDetect),I=k.verdict!=="key_found",ae=new Date().toISOString().slice(0,10),L={answer:o,anchors:k,caseId:e.id,caseTitle:e.title,model:i,runDate:ae,gap:e.gap,category:e.category,observedDate:e.observedDate},de=jt({mode:"curated",case_id:e.id,model:i,email:r,open_prompt:e.openPrompt,mechanism:e.mechanism,open_answer:o,gap_held:I,detect_verdict:k.verdict}),Q=await Ne(de);f({...L,submitOk:Q.ok}),m(de),g(!1),s(2),window.requestAnimationFrame(V)},te=["wb-specimen-plate","wb-run-plate","wb-measure-channel","wb-scroll-anchor",a===2?"is-result":"",P==="out"?"is-crossfade-out":"",P==="in"?"is-crossfade-in":""].filter(Boolean).join(" ");return React.createElement("div",{className:"wb-console"},React.createElement("div",{className:"wb-console__main"},React.createElement("div",{ref:G,className:"wb-scroll-anchor"}),React.createElement("p",{className:"wb-plate-note"},"Curated cases are drawn from the archive. Public case pages are published separately."),React.createElement("div",{className:"wb-case-selector"},se.map(c=>{let k=c.id===e.id;return React.createElement("button",{key:c.id,type:"button",className:`wb-case-card wb-specimen-plate wb-focus wb-measure-channel${k?" is-active":""}${c.ready?"":" is-disabled"}`,onClick:()=>ie(c),disabled:!c.ready},c.ready?React.createElement("div",{className:"wb-specimen-plate__label"},$t(c)):React.createElement(j,null,"To add"),React.createElement("div",{className:"wb-case-card__title"},c.title))})),e.ready?React.createElement("div",{className:"wb-console__measure"},React.createElement("div",{className:"wb-console__measure-main"},React.createElement("div",{ref:q,className:te},a===2&&w?React.createElement(la,{...w,candidate:b,sequenceReady:D,onAnotherCase:F,onEmailFollow:c=>{n(c);let k={...b,email:c};m(k),Ne(k)}}):a===1?React.createElement("div",{className:"wb-flow-module wb-flow-module--input"},React.createElement(We,{c:e}),React.createElement("div",{className:"wb-input-bay"},React.createElement(z,{label:"Which AI did you ask?"},React.createElement(ye,{value:i,onChange:l}))),React.createElement("div",{className:"wb-input-bay"},React.createElement(ue,{label:"Paste the model's open answer",value:o,onChange:c=>{u(c),C("")},error:h,placeholder:"Paste the full response here\u2026",minAckLength:20})),h?React.createElement("div",{className:"wb-field-error"},h):null,React.createElement("div",{className:"wb-action-row"},React.createElement(N,{kind:"primary",disabled:p||!i||o.trim().length<200,onClick:J},"Compare with what Imbas observed \u2192")),!p&&!h&&o.trim().length>0&&o.trim().length<200?React.createElement("p",{className:"wb-plate-hint"},"Paste the full answer \u2014 we need enough text to check reliably (200 characters minimum)."):null):React.createElement("div",{className:"wb-flow-module wb-flow-module--readout"},React.createElement("div",{className:"wb-readout"},React.createElement("div",{className:"wb-readout__specimen"},React.createElement(We,{c:e})),React.createElement("div",{className:"wb-readout__rule","aria-hidden":"true"}),React.createElement("div",{className:"wb-readout__section"},React.createElement(j,null,"What Imbas measured"),React.createElement("div",{className:"wb-active-case__headline"},e.short)),React.createElement("div",{className:"wb-readout__signal"},React.createElement("p",{className:"wb-active-case__probe"},"Will your model surface it?")),React.createElement("div",{className:"wb-readout__run-strip"},React.createElement("span",null,"gap ",e.gap.toFixed(1)," / 3"),React.createElement("span",null,e.category),React.createElement("span",null,"4 frontier models tested")),React.createElement("div",{className:"wb-readout__rule","aria-hidden":"true"}),React.createElement("p",{className:"wb-plate-support wb-readout__notes"},e.whyItMatters)))),a===0&&React.createElement("div",{className:"wb-confirm-block wb-flow-module"},React.createElement(j,null,"Confirm it yourself"),React.createElement("div",{className:"wb-input-bay"},React.createElement("span",{className:"wb-input-bay__tag"},"Open prompt"),React.createElement(Ae,{text:e.openPrompt})),React.createElement("div",{className:"wb-action-row"},React.createElement(N,{kind:"ghost",small:!0,onClick:Y,className:x?"is-copied":""},x?"Copied \u2713":"Copy question"),React.createElement(N,{kind:"primary",onClick:()=>s(1)},"Ran it \u2014 paste the answer \u2192")),React.createElement(Lt,null),React.createElement(Ft,null),React.createElement("p",{className:"wb-plate-hint"},"Models change, so your run may differ \u2014 a closed gap is a result too.")),React.createElement(ct,null))):React.createElement("div",{className:"wb-plate-note wb-plate-note--dashed"},e.note)))}var ke={...ne,padding:"11px 13px 10px",fontSize:15,minHeight:40,resize:"none"},Ze={...ke,minHeight:"unset",resize:"vertical"};function ct({variant:e="default"}){let[t,a]=d(!1),[s,r]=d("form"),[n,i]=d(""),[l,o]=d(""),[u,p]=d(""),[g,w]=d(""),[f,b]=d(!1),[m,x]=d(null),y=n.trim().length>=4,h=l.trim().length>=8,C=y&&h&&!f;async function D(){if(!C)return;b(!0),x(null);let S=Yt({topic:n.trim(),inspect_question:l.trim(),context:u.trim()||null,email:g.trim()||null,source:"workbench_suggest"}),P=await Ne(S);b(!1),P.ok?r("done"):x(S)}return s==="done"?React.createElement("section",{id:"wb-suggest-module",className:"wb-suggest-module is-done","aria-labelledby":"wb-suggest-heading"},React.createElement("div",{className:"wb-flow-module wb-flow-module--suggest"},React.createElement("div",{className:"wb-status-readout"},React.createElement("p",{className:"wb-status-readout__title"},"Thank you."),React.createElement("p",{className:"wb-status-readout__body"},"Your submission has been recorded for review."),React.createElement("p",{className:"wb-plate-hint"},"Selected investigations may become future Imbas cases after human review.")))):t?React.createElement("section",{id:"wb-suggest-module",className:"wb-suggest-module is-expanded","aria-labelledby":"wb-suggest-heading"},React.createElement("div",{className:"wb-flow-module wb-flow-module--input wb-flow-module--suggest"},React.createElement("p",{className:"wb-suggest-module__eyebrow"},"Field contribution"),React.createElement("h2",{id:"wb-suggest-heading",className:"wb-suggest-module__heading"},"Suggest an Investigation"),React.createElement("p",{className:"wb-suggest-module__lead"},"Help expand the archive."),React.createElement("p",{className:"wb-suggest-module__support"},"Submit a topic, claim, or behavior pattern that may deserve inspection."),React.createElement("p",{className:"wb-plate-hint"},"Selected submissions may become future Imbas records after review."),React.createElement("div",{className:"wb-input-bay"},React.createElement(z,{label:"Topic or Question"},React.createElement("input",{className:U,type:"text",value:n,onChange:S=>i(S.target.value),placeholder:"e.g. Model claims about historical events",autoComplete:"off",style:ke}))),React.createElement("div",{className:"wb-input-bay"},React.createElement(z,{label:"What should be inspected?"},React.createElement("textarea",{className:U,value:l,onChange:S=>o(S.target.value),placeholder:"Describe the claim, behavior, or pattern Imbas should examine",rows:3,style:Ze}))),React.createElement("div",{className:"wb-input-bay"},React.createElement(z,{label:"Optional context, source, or link"},React.createElement("textarea",{className:U,value:u,onChange:S=>p(S.target.value),placeholder:"URL, excerpt, or background (optional)",rows:2,style:Ze}))),React.createElement("div",{className:"wb-input-bay"},React.createElement(z,{label:"Optional email for follow-up"},React.createElement("input",{className:U,type:"email",value:g,onChange:S=>w(S.target.value),placeholder:"you@example.com (optional)",autoComplete:"email",style:ke}))),m?React.createElement(lt,{candidate:m}):null,React.createElement("div",{className:"wb-action-row"},React.createElement(N,{kind:"primary",disabled:!C,onClick:D},f?"Submitting\u2026":"Submit Investigation")))):e==="reader-secondary"?React.createElement("section",{id:"wb-suggest-module",className:"wb-suggest-module is-collapsed is-reader-secondary","aria-labelledby":"wb-suggest-heading"},React.createElement("div",{className:"wb-flow-module wb-flow-module--suggest"},React.createElement("h2",{id:"wb-suggest-heading",className:"wb-suggest-module__heading"},"Suggest an Investigation"),React.createElement("p",{className:"wb-suggest-module__lead"},"Have a case we should inspect? Send it."),React.createElement("div",{className:"wb-action-row wb-suggest-cta-row"},React.createElement(N,{kind:"ghost",small:!0,onClick:()=>a(!0)},"Suggest")))):React.createElement("section",{id:"wb-suggest-module",className:"wb-suggest-module is-collapsed","aria-labelledby":"wb-suggest-heading"},React.createElement("div",{className:"wb-flow-module wb-flow-module--suggest"},React.createElement("p",{className:"wb-suggest-module__eyebrow"},"Field contribution"),React.createElement("h2",{id:"wb-suggest-heading",className:"wb-suggest-module__heading"},"Suggest an Investigation"),React.createElement("p",{className:"wb-suggest-module__lead"},"Help expand the archive."),React.createElement("p",{className:"wb-suggest-module__support"},"Submit a topic, claim, or behavior pattern that may deserve inspection."),React.createElement("div",{className:"wb-action-row wb-suggest-cta-row"},React.createElement(N,{kind:"primary",onClick:()=>a(!0)},"Suggest an investigation \u2192"))))}var Xe={idle:"Paste an answer to inspect it.",needQuestion:"Add the question you asked.",ready:"Let's see what might be missing\u2026",inspecting:"Reading the answer\u2026",result:"Inspection complete."},et=["Reading the answer\u2026","Checking what might be missing\u2026","Found something to check\u2026"],da={full:"FULL",partial:"PARTIAL",thin:"THIN"},Ce={full:"The answer substantially served the question.",partial:"Some material context was missing or shaped.",thin:"The answer was evasive or substantially incomplete."};function ua({state:e}){let[t,a]=d(0);M(()=>{if(e!=="inspecting"){a(0);return}let r=window.setInterval(()=>{a(n=>Math.min(n+1,et.length-1))},1100);return()=>window.clearInterval(r)},[e]);let s=e==="inspecting"?et[t]:Xe[e]||Xe.idle;return React.createElement("div",{className:`wb-reader-v2__status-wrap is-${e}`,role:"status","aria-live":"polite"},React.createElement("span",{className:"wb-reader-v2__status-dot","aria-hidden":"true"}),React.createElement("p",{className:`wb-reader-v2__status is-${e}`},s))}function ma(e){if(e!=null&&e.reason)return String(e.reason).replace(/^read_/,"");let a=((e==null?void 0:e.the_read)||"").match(/\(([a-z_]+)\)/i);return a?a[1]:""}function pa(e){let t=ma(e).toLowerCase();return t==="ceiling"?"Reader limit reached \u2014 showing fallback check.":["no_key","disabled","api_error","network","bad_json"].includes(t)?"Reader temporarily unavailable \u2014 showing fallback check.":"Reader unavailable \u2014 showing fallback check."}function Se(){return"The full Reader is unavailable. Your question and answer are preserved above \u2014 this is not a full inspection."}function dt({mode:e,sel:t,result:a}){return(a==null?void 0:a.source)==="fallback"?"Fallback check":(a==null?void 0:a.source)!=="agent"?"Reader":e==="guided"&&(t!=null&&t.id)?`Reader agent \xB7 Case ${t.id}`:"Reader agent \xB7 Custom answer"}function ut(e){let t=(e==null?void 0:e.completeness)||"partial",a=t.toUpperCase(),s=Ce[t]||Ce.partial,r=Array.isArray(e==null?void 0:e.what_was_left_out)?e.what_was_left_out.filter(Boolean):[],n=((e==null?void 0:e.how_it_was_shaped)||"").trim(),i=((e==null?void 0:e.inspection_note)||"").trim(),l=[`Completeness: ${a}`,s,"","THE READ",(e==null?void 0:e.the_read)||"","","WHAT WAS LEFT OUT",...r.length?r.map(o=>`- ${o}`):["- (none identified)"],"","HOW IT WAS SHAPED",n||"(none detected)"];return i&&l.push("","INSPECTION NOTE",i),l.join(`
